...
namespace ReactiveUI
{
    public static class AutoPersistHelper
    {
        ...
        /// be saved.</param>
        /// <returns>A Disposable to disable automatic persistence.</returns>
        public static IDisposable AutoPersistCollection<T>(this IReadOnlyReactiveCollection<T> This, Func<T, IObservable<Unit>> doPersist, TimeSpan? interval = null)
            where T : IReactiveObject
        {
        ...
        /// be saved.</param>
        /// <returns>A Disposable to disable automatic persistence.</returns>
        public static IDisposable AutoPersistCollection<T, TDontCare>(this IReadOnlyReactiveCollection<T> This, Func<T, IObservable<Unit>> doPersist, IObservable<TDontCare> manualSaveSignal, TimeSpan? interval = null)
            where T : IReactiveObject
        {
        ...
        public static IDisposable ActOnEveryObject<T>(this IReadOnlyReactiveCollection<T> This, Action<T> onAdd, Action<T> onRemove)
            where T : IReactiveObject
        {
