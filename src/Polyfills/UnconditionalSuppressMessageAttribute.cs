...
[SuppressMessage(
    ...
    Justification = "Mirrors the shape of the corresponding BCL type (System.Diagnostics.CodeAnalysis.UnconditionalSuppressMessageAttribute); the polyfill compiles only where the BCL lacks it.")]
