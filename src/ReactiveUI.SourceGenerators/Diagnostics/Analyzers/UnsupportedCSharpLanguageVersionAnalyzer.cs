...
public sealed class UnsupportedCSharpLanguageVersionAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableDictionary<string, string> GeneratorAttributeNamesToFullyQualifiedNamesMap = ImmutableDictionary.CreateRange(new[]
    {
        ...
        new KeyValuePair<string, string>("NotifyCanExecuteChangedForAttribute", "ReactiveUI.SourceGenerators.NotifyCanExecuteChangedForAttribute"),
        new KeyValuePair<string, string>("NotifyDataErrorInfoAttribute", "ReactiveUI.SourceGenerators.NotifyDataErrorInfoAttribute"),
        new KeyValuePair<string, string>("NotifyPropertyChangedForAttribute", "ReactiveUI.SourceGenerators.NotifyPropertyChangedForAttribute"),
        new KeyValuePair<string, string>("NotifyPropertyChangedRecipientsAttribute", "ReactiveUI.SourceGenerators.NotifyPropertyChangedRecipientsAttribute"),
        new KeyValuePair<string, string>("ReactiveObjectAttribute", "ReactiveUI.SourceGenerators.ReactiveObjectAttribute"),
        new KeyValuePair<string, string>("ReactivePropertyAttribute", "ReactiveUI.SourceGenerators.ReactivePropertyAttribute"),
