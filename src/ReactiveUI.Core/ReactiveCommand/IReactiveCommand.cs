...
{
    /// <summary>Gets an observable whose value indicates whether the command is currently executing.</summary>
    /// <value>
    /// The is executing.
    /// </value>
    /// <remarks>
    ...
    /// <summary>Gets an observable whose value indicates whether the command can currently execute.</summary>
    /// <value>
    /// The can execute.
    /// </value>
    /// <remarks>
