...
/// <summary>Represents an exception that is thrown when an unhandled error occurs during application execution.</summary>
...
[System.Diagnostics.DebuggerDisplay("Message = {Message}")]
#if !NET8_0_OR_GREATER
[Serializable]
#endif
public class UnhandledErrorException : Exception
{
    /// <summary>Initializes a new instance of the <see cref="UnhandledErrorException"/> class.</summary>
