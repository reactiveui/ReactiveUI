...
/// <summary>Provides access to the <see cref="IViewLocator"/> registered in the global dependency resolver.</summary>
/// <remarks>
/// <para>
...
{
    /// <summary>Gets the currently registered <see cref="IViewLocator"/> from <see cref="AppLocator.Current"/>.</summary>
