...
/// <summary>Convenience class providing a starting point for chaining comparers for anonymous types.</summary>
/// <remarks>
...
public static class OrderedComparer
{
    ...
    private sealed class OrderedComparerTypeWrapper<T> : IComparerBuilder<T>
    {
        ...
        /// <summary>Creates a comparer that orders elements in descending order according to a specified key selector and comparer.</summary>
        /// <typeparam name="TValue">The type of the key returned by the selector function.</typeparam>
