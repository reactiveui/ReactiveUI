...
/// <summary>Provides cached instances of commonly used <see cref="PropertyChangedEventArgs"/> objects for singleton property change notifications.</summary>
...
{
    /// <summary>Provides a cached instance of PropertyChangedEventArgs for the Value property.</summary>
    ...
    /// <summary>Provides a static instance of <see cref="PropertyChangedEventArgs"/> for the <see cref="INotifyDataErrorInfo.HasErrors"/> property.</summary>
    ...
    /// <summary>Provides a PropertyChangedEventArgs instance for the ErrorMessage property.</summary>
