...
/// <summary>Provides a singleton instance of the <see cref="DataErrorsChangedEventArgs"/> class for use with data error notifications.</summary>
...
/// significant.</remarks>
public static class SingletonDataErrorsChangedEventArgs
{
    /// <summary>Represents a static instance of the <see cref="DataErrorsChangedEventArgs"/> class for the 'Value' property.</summary>
