...
/// <summary>Implement this to override how RoutedViewHost and ViewModelViewHost map view models to views.</summary>
/// <remarks>
/// <para>
...
public interface IViewLocator : IEnableLogger
{
    ...
    /// <summary>Resolves a view for a view model instance using runtime type information.</summary>
