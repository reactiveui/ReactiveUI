...
/// <summary>Represents a component that can produce change notifications for a given property on a given object.</summary>
/// <remarks>
...
public interface ICreatesObservableForProperty : IEnableLogger
{
    ...
    /// <summary>Subscribes to after-change notifications for the specified propertyName on sender.</summary>
    ...
    /// <summary>Subscribes to change notifications for the specified propertyName on sender.</summary>
    /// <param name="sender">The object to observe.</param>
    /// <param name="expression">The expression describing the observed member.</param>
    /// <param name="propertyName">The property name to observe.</param>
    /// <param name="beforeChanged">
