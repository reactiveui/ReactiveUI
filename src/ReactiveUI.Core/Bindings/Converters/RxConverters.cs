...
/// <summary>Provides static access to the ReactiveUI converter service.</summary>
/// <remarks>
/// <para>
...
/// startup via the <c>ReactiveUIBuilder</c> pattern.
/// </para>
/// <para>
...
{
    /// <summary>Backing field for the converter service.</summary>
    ...
    /// </para>
    /// <para>
    /// The service is initialized during application startup via <c>ReactiveUIBuilder</c>.
    ...
    /// <remarks>
    /// <para>
    /// This method is called internally by <c>ReactiveUIBuilder</c> during application
