...
/// <summary>Provides unified access to all converter registries in ReactiveUI.</summary>
/// <remarks>
/// <para>
...
public sealed class ConverterService
{
        ...
        Type toType)
    {
        ...
        return typed ?? (object?)FallbackConverters.TryGetConverter(fromType, toType);
    }
    ...
    public ISetMethodBindingConverter? ResolveSetMethodConverter(
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)]
        Type? toType) =>
        SetMethodConverters.TryGetConverter(fromType, toType);
}
