    ...
    where TView : IViewFor
{
    ...
    /// <summary>Gets the instance of the view this binding is applied to.</summary>
    TView View { get; }
    ...
    /// <summary>Gets an observable representing changed values for the binding.</summary>
