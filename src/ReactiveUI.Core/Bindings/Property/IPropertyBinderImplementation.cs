...
/// <summary>This interface represents an object that is capable of providing binding implementations.</summary>
public interface IPropertyBinderImplementation : IEnableLogger
{
    /// <summary>Creates a two-way binding between a view model and a view using a conversion hint and no converter overrides.</summary>
    ...
    /// <summary>Creates a two-way binding between a view model and a view using a conversion hint and converter overrides.</summary>
    /// <typeparam name="TViewModel">The type of the view model that is bound.</typeparam>
    /// <typeparam name="TView">The type of the view being bound.</typeparam>
    /// <typeparam name="TViewModelPropertyType">The type of the property bound on the view model.</typeparam>
    /// <typeparam name="TViewPropertyType">The type of the property bound on the view.</typeparam>
    ...
    /// <summary>Creates a one-way binding from view model to view using default converters and conversion hint.</summary>
    /// <typeparam name="TViewModel">The type of the view model that is bound.</typeparam>
    ...
    /// <summary>Creates a one-way binding from view model to view with an optional converter override and default conversion hint.</summary>
    /// <typeparam name="TViewModel">The type of the view model that is bound.</typeparam>
    /// <typeparam name="TView">The type of the view that is bound.</typeparam>
    /// <typeparam name="TViewModelPropertyType">The type of the property bound on the view model.</typeparam>
    /// <typeparam name="TViewPropertyType">The type of the property bound on the view.</typeparam>
    ...
    /// <summary>Creates a one-way binding from view model to view using only a conversion hint.</summary>
    /// <typeparam name="TViewModel">The type of the view model that is bound.</typeparam>
    /// <typeparam name="TView">The type of the view that is bound.</typeparam>
    /// <typeparam name="TViewModelPropertyType">The type of the property bound on the view model.</typeparam>
    /// <typeparam name="TViewPropertyType">The type of the property bound on the view.</typeparam>
    ...
    /// <summary>Creates a one-way binding from view model to view with an optional converter override.</summary>
    /// <typeparam name="TViewModel">The type of the view model that is bound.</typeparam>
    /// <typeparam name="TView">The type of the view that is bound.</typeparam>
    /// <typeparam name="TViewModelPropertyType">The type of the property bound on the view model.</typeparam>
    /// <typeparam name="TViewPropertyType">The type of the property bound on the view.</typeparam>
    ...
    /// <summary>Binds an observable stream to a target property using default converters and conversion hint.</summary>
    ...
    /// <summary>Binds an observable stream to a target property using only a conversion hint.</summary>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <typeparam name="TTarget">The target type.</typeparam>
    /// <typeparam name="TTargetValue">The target value type.</typeparam>
    /// <param name="observedChange">The target observable to bind to.</param>
    ...
    /// <summary>Binds an observable stream to a target property with an optional converter override.</summary>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <typeparam name="TTarget">The target type.</typeparam>
    /// <typeparam name="TTargetValue">The target value type.</typeparam>
    /// <param name="observedChange">The target observable to bind to.</param>
