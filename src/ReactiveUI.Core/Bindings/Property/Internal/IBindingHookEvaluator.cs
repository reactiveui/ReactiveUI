...
/// <summary>Internal interface for evaluating binding hooks.</summary>
/// <remarks>
...
{
    /// <summary>Evaluates all registered binding hooks.</summary>
    /// <typeparam name="TViewModel">The view model type.</typeparam>
    /// <typeparam name="TView">The view type.</typeparam>
    /// <param name="viewModel">The view model instance.</param>
    /// <param name="view">The view instance.</param>
    /// <param name="viewModelExpression">The rewritten view model expression.</param>
