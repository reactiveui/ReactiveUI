...
/// <summary>Internal interface for compiling and analyzing property binding expressions.</summary>
/// <remarks>
...
/// </remarks>
public interface IPropertyBindingExpressionCompiler
{
    /// <summary>Creates the set-then-get function for property binding.</summary>
    ...
    /// <summary>Determines if a view expression is a direct member on the root parameter.</summary>
    ...
    /// <summary>Gets the expression chain array for host change tracking.</summary>
    ...
    /// <summary>Determines if values should be replayed when the host changes.</summary>
    ...
    /// <summary>Creates an observable for direct member binding (no intermediate chain).</summary>
    ...
    /// <summary>Creates an observable for chained member binding (with intermediate host changes).</summary>
    /// <typeparam name="TTarget">The target object type.</typeparam>
    /// <typeparam name="TValue">The property value type.</typeparam>
    /// <typeparam name="TObs">The observed change type.</typeparam>
    /// <param name="target">The target object instance.</param>
