...
/// <summary>Internal interface for resolving binding type converters.</summary>
/// <remarks>
...
/// </remarks>
public interface IBindingConverterResolver
{
    /// <summary>Gets a binding type converter for the specified type pair.</summary>
    ...
    /// <summary>Gets a set-method binding converter for the specified type pair.</summary>
    /// <param name="fromType">The source type.</param>
