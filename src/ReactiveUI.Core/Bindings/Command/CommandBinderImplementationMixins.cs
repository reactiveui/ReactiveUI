...
/// <summary>Internal implementation details which performs Binding ICommand's to controls.</summary>
internal static class CommandBinderImplementationMixins
{
    /// <summary>Provides command binding extension members for <see cref="ICommandBinderImplementation"/>.</summary>
    /// <param name="this">The command binder implementation used to perform the binding.</param>
    extension(ICommandBinderImplementation @this)
    {
        /// <summary>
        ...
        TControl>(
            ...
            @this.BindCommand(viewModel, view, propertyName, controlName, Signal.None<object>(), toEvent);
    }
}
