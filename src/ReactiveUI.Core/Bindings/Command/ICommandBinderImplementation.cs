...
/// <summary>Implementation logic for command binding.</summary>
public interface ICommandBinderImplementation : IEnableLogger
{
    /// <summary>
    ...
    /// <param name="viewModelProperty">An expression identifying the command property on the view model to bind. Cannot be null.</param>
