...
/// <summary>Creates command bindings for objects that expose <c>Command</c> and <c>CommandParameter</c> as public instance properties.</summary>
/// <remarks>
/// <para>
...
public sealed class CreatesCommandBindingViaCommandParameter : ICreatesCommandBinding
{
    ...
    /// <summary>Per-closed-generic cache of resolved command properties for a target type <typeparamref name="T"/>.</summary>
    /// <typeparam name="T">
    ...
    T>
    {
        /// <summary>Gets a value indicating whether the target type exposes both required properties.</summary>
        internal static readonly bool HasRequiredProperties;

        /// <summary>Gets the resolved public instance property named <c>Command</c>, or <see langword="null"/> if missing.</summary>
        ...
        /// <summary>Resolves required properties via a single pass over public instance properties.</summary>
