...
/// <summary>A <see cref="ViewModelViewHost"/> that also finds views registered only with the service locator.</summary>
/// <remarks>
/// <para>
/// <see cref="ViewModelViewHost"/> asks the view locator's generated view lookup and its <c>Map</c> registrations.
...
/// ahead of time. Use <see cref="ViewModelViewHost"/> when you can.
/// </para>
/// </remarks>
[RequiresDynamicCode(ViewResolutionMessages.UnsafeHost)]
[DebuggerDisplay("{ViewContractObservable}, {DefaultContent}")]
public class ViewModelViewHostUnsafe : ViewModelViewHost
{
