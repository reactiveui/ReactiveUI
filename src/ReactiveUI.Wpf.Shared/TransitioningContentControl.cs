...
#endif
/// <summary>A <see cref="ContentControl"/> that animates the visual transition whenever its <see cref="ContentControl.Content"/> changes.</summary>
/// <remarks>
/// <para>
...
public class TransitioningContentControl : ContentControl
{
    ...
    /// <summary>The name of the visual state group that contains the transition states.</summary>
    private const string PresentationGroup = "PresentationStates";

    /// <summary>The name of the resting (non-transitioning) visual state.</summary>
    private const string NormalState = "Normal";

    /// <summary>The default transition duration, in seconds.</summary>
    private const double DefaultDurationSeconds = 0.3;

    /// <summary>The DPI scale used when DPI scaling is overridden for testing.</summary>
    private const double OverrideDpiScale = 1.25;

    /// <summary>The minimum pixel dimension used when creating a render target bitmap.</summary>
    private const double MinimumPixelDimension = 1.0;

    /// <summary>The number of states the bounce transition waits for before completing.</summary>
    ...
    /// <summary>Occurs when a transition has completed.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets the direction used by directional transitions.</summary>
    /// <value>
    ...
    /// <summary>Gets or sets a value indicating whether to override DPI scaling for testing.</summary>
    internal static bool OverrideDpi { get; set; }

    /// <summary>Gets or sets the starting transition storyboard for testing.</summary>
    ...
    /// <summary>Gets or sets the completing transition storyboard for testing.</summary>
    ...
    /// <summary>Gets the current content presentation site for testing.</summary>
    internal ContentPresenter? CurrentContentPresentationSite { get; private set; }

    /// <summary>Gets or sets the presentation state group for testing.</summary>
    internal VisualStateGroup? PresentationStateGroup { get; set; }

    /// <summary>Gets or sets the grid container associated with this instance.</summary>
    private Grid? Container { get; set; }

    /// <summary>Gets or sets the previous image associated with the site.</summary>
    ...
    /// <summary>Creates a render target bitmap from the specified UI element.</summary>
    ...
    /// <summary>Sets default values for fade transitions.</summary>
    ...
    /// <summary>Prepares the transition by capturing the current content as an image and setting the new content.</summary>
    ...
    /// <summary>Configures the bounce transition by setting up both the outgoing and incoming storyboards.</summary>
    ...
    /// <summary>Configures a standard (non-bounce) transition by setting up the appropriate storyboard.</summary>
    ...
    /// <summary>Retrieves the storyboard associated with the specified transition name from the visual state group.</summary>
    ...
    {
        ArgumentValidation.ThrowIfNullOrWhiteSpace(transitionName);
    ...
    /// <summary>Aborts the transition.</summary>
