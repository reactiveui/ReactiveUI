...
/// <summary>Provides a stable identifier that is unique to the current running instance of the application.</summary>
/// <remarks>
...
{
    /// <summary>The identifier generated once per process, used to distinguish this app instance from others.</summary>
