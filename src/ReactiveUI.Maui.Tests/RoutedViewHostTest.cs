...
using ReactiveUI.Maui.Tests.Mocks;
...
public sealed class RoutedViewHostTest : IDisposable
{
    ...
    public void NewRoutedViewHostHasNoCurrentPage()
    {
        ...
        Assert.Equal(0, (fixture as INavigationPageController).StackDepth);
    }
    ...
    public void NewRoutedViewHostHasMainViewCurrentPage()
    {
        ...
        Assert.Equal(1, (fixture as INavigationPageController).StackDepth);
    }
    ...
    public async Task NavigateToChildView()
    {
        ...
        Assert.Equal(2, (fixture as INavigationPageController).StackDepth);
    }
    ...
    public async Task NavigateToSecondChildView()
    {
        ...
        Assert.Equal(3, (fixture as INavigationPageController).StackDepth);
    }
    ...
    public async Task GoBackFromChildView(bool animated, bool fast)
    {
        ...
        await _navigationViewModel.Navigate(nameof(ChildViewModel));
        await (fixture as INavigationPageController).PopAsyncInner(animated, fast).ConfigureAwait(true);
