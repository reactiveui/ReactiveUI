...
public class AssemblyHooks
{
    ...
    {
        Console.WriteLine($"[ASSEMBLY] ReactiveUI.Builder.Tests - Starting at {DateTime.Now:HH:mm:ss.fff}");
    ...
    public static void AssemblyTeardown()
    {
        ...
        Console.WriteLine($"[ASSEMBLY] ReactiveUI.Builder.Tests - Ending at {DateTime.Now:HH:mm:ss.fff}");
