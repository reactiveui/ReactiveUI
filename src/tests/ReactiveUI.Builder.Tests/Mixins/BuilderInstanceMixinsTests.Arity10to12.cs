...
/// <content>
/// WithInstance tests for arities ten through twelve.
/// </content>
public partial class BuilderInstanceMixinsTests
{
    /// <summary>
    /// Verifies that the 10-types WithInstance builder instance method invokes the action with the resolved instances.
    /// </summary>
    ...
    /// <summary>
    /// Verifies that the 10-types WithInstance builder instance method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>
    /// Verifies that the 10-types WithInstance extension method invokes the action with the resolved instances.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 10-types WithInstance extension method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 11-types WithInstance builder instance method invokes the action with the resolved instances.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>
    /// Verifies that the 11-types WithInstance builder instance method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 11-types WithInstance extension method invokes the action with the resolved instances.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 11-types WithInstance extension method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 12-types WithInstance builder instance method invokes the action with the resolved instances.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>
    /// Verifies that the 12-types WithInstance builder instance method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 12-types WithInstance extension method invokes the action with the resolved instances.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    /// <summary>
    /// Verifies that the 12-types WithInstance extension method skips the action when the current resolver is null.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
