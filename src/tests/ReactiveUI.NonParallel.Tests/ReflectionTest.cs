...
public class ReflectionTest
{
    ...
    public async Task TrySetValueToPropertyChain_NullInChain_ReturnsFalse()
    {
        ...
        var success = Reflection.TrySetValueToPropertyChain(fixture, chain, "Value", shouldThrow: false);
    ...
    public async Task TrySetValueToPropertyChain_NullTargetWithThrow_Throws()
    {
        ...
        await Assert.That(() => Reflection.TrySetValueToPropertyChain<string>(null, chain, "Value", shouldThrow: true))
            .Throws<ArgumentNullException>();
    }
    ...
    {
        var result = Reflection.ReallyFindType("InvalidType.DoesNotExist", throwOnFailure: false);
    ...
    {
        await Assert.That(() => Reflection.ReallyFindType("InvalidType.DoesNotExist", throwOnFailure: true))
    ...
    {
        var result = Reflection.GetEventArgsTypeForEvent(typeof(TestClassWithEvent), nameof(TestClassWithEvent.TestEvent));
    ...
    {
        var propertyInfo = typeof(TestClassWithStaticProperty).GetProperty(nameof(TestClassWithStaticProperty.StaticProperty))!;
    ...
    {
        var propertyInfo = typeof(TestClassWithStaticProperty).GetProperty(nameof(TestClassWithStaticProperty.InstanceProperty))!;
    ...
    private class TestClassWithField
    {
        ...
        /// A test field.
        /// </summary>
        [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1401:Fields should be private", Justification = "Needed for test")]
