...
public static class AssemblyHooks
{
    ...
    {
        Console.WriteLine($"[ASSEMBLY] ReactiveUI.Splat.Tests - Starting at {DateTime.Now:HH:mm:ss.fff}");
    ...
    public static void AssemblyTeardown()
    {
        ...
        Console.WriteLine($"[ASSEMBLY] ReactiveUI.Splat.Tests - Ending at {DateTime.Now:HH:mm:ss.fff}");
