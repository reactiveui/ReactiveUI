...
/// <summary>Tests for <see cref="IROObservableForProperty" />.</summary>
public class IroObservableForPropertyTest
{
    /// <summary>The property name used when querying affinity in the tests.</summary>
    private const string TestPropertyName = "TestProperty";

    /// <summary>Tests that GetAffinityForObject returns 10 for IReactiveObject types.</summary>
    ...
    /// <summary>Tests that GetAffinityForObject returns 0 for non-IReactiveObject types.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests that GetAffinityForObject returns 10 regardless of beforeChanged parameter.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests that GetNotificationForProperty throws for non-IReactiveObject sender.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests that GetNotificationForProperty throws for null expression.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests that GetNotificationForProperty emits when property changes.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests that GetNotificationForProperty returns observable for property changes.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
