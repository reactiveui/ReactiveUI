...
public class WhenAnyDynamicTest
{
    ...
    public async Task WhenAnyDynamic_10Props_Selector()
    {
        ...
        vm.WhenAnyDynamic(
                ...
                property9,
                property10,
                (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10) => "x").ObserveOn(ImmediateScheduler.Instance).Subscribe(list.Add);
        await Assert.That(list).Count().IsGreaterThan(0);
        vm.Property1 = "a";
        await Assert.That(list).Count().IsGreaterThan(1);
    }
    ...
    public async Task WhenAnyDynamic_11Props_Selector()
    {
        ...
        vm.WhenAnyDynamic(
                ...
                property10,
                property11,
                (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11) => "x").ObserveOn(ImmediateScheduler.Instance).Subscribe(list.Add);
        await Assert.That(list).Count().IsGreaterThan(0);
        vm.Property1 = "a";
        await Assert.That(list).Count().IsGreaterThan(1);
    }
    ...
    public async Task WhenAnyDynamic_12Props_Selector()
    {
        ...
        vm.WhenAnyDynamic(
                ...
                property11,
                property12,
                (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12) => "x").ObserveOn(ImmediateScheduler.Instance).Subscribe(list.Add);
        await Assert.That(list).Count().IsGreaterThan(0);
        vm.Property1 = "a";
        await Assert.That(list).Count().IsGreaterThan(1);
    }
