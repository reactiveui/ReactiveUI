...
/// <content>
/// Arity-5 WhenAny and WhenAnyValue overload tests.
/// </content>
public partial class WhenAnyMixinTests
{
    /// <summary>
    ///     Verifies the WhenAny overload for 5 properties with a selector.
    /// </summary>
    ...
    /// <summary>
    ///     Verifies the WhenAny overload for 5 properties with a selector and distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the string-based WhenAny overload for 5 properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the string-based WhenAny overload for 5 properties with a selector and distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the WhenAnyValue overload for 5 properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the WhenAnyValue overload for 5 properties with a selector and distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the string-based WhenAnyValue overload for 5 properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the string-based WhenAnyValue overload for 5 properties with a selector and distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the tuple expression-based WhenAnyValue overload for 5 properties.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the tuple expression-based WhenAnyValue overload for 5 properties with a distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Verifies the tuple string-based WhenAnyValue overload for 5 properties.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    public async Task WhenAnyValue_5Props_Tuple_Str()
    {
        ...
        vm.WhenAnyValue<WhenAnyArityTestViewModel, string?, string?, string?, string?, string?>(
            ...
            nameof(WhenAnyArityTestViewModel.Property3),
            nameof(WhenAnyArityTestViewModel.Property4),
            nameof(WhenAnyArityTestViewModel.Property5)).ObserveOn(ImmediateScheduler.Instance).Subscribe(list.Add);
        await Assert.That(list).Count().IsGreaterThan(0);
    }

    /// <summary>
    ///     Verifies the tuple string-based WhenAnyValue overload for 5 properties with a distinct-until-changed flag.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
