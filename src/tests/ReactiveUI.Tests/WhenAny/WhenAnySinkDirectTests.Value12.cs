...
/// <content>Direct arity-12 <c>WhenAnyValueSink</c> coverage.</content>
...
public partial class WhenAnySinkDirectTests
{
    ...
    [Test]
    public async Task ValueSink12_Emits()
    {
        ...
        var s12 = new Subject<IObservedChange<object?, string>>();
        var rec = new Recorder<string>();
        using var sub = new WhenAnyValueSink<object?, string, string, string, string, string, string, string, string, string, string, string, string, string>(
            s1,
            s2,
            s3,
            s4,
    ...
    /// <summary>Verifies the arity-12 value sink forwards a source error to the observer.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ValueSink12_ForwardsError()
    {
        ...
        var e12 = new Subject<IObservedChange<object?, string>>();
        var rec = new Recorder<string>();
        new WhenAnyValueSink<object?, string, string, string, string, string, string, string, string, string, string, string, string, string>(
            e1,
            e2,
            e3,
            e4,
    ...
    /// <summary>Verifies the arity-12 value sink completes once every source completes.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ValueSink12_Completes()
    {
        ...
        var k12 = new Subject<IObservedChange<object?, string>>();
        var rec = new Recorder<string>();
        new WhenAnyValueSink<object?, string, string, string, string, string, string, string, string, string, string, string, string, string>(
            k1,
            k2,
    ...
    /// <summary>Verifies a throwing selector surfaces as an error from the arity-12 value sink.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ValueSink12_SelectorThrows()
    {
        ...
        var t12 = new Subject<IObservedChange<object?, string>>();
        var rec = new Recorder<string>();
        new WhenAnyValueSink<object?, string, string, string, string, string, string, string, string, string, string, string, string, string>(
            t1,
            t2,
            ...
            t11,
            t12,
            (_, _, _, _, _, _, _, _, _, _, _, _) => throw ex).Subscribe(rec);
        t1.OnNext(Ch("a"));
        t2.OnNext(Ch("a"));
        t3.OnNext(Ch("a"));
        t4.OnNext(Ch("a"));
