...
{
    /// <summary>Verifies the WhenAny overload for 8 properties with a selector.</summary>
    ...
    /// <summary>Verifies the WhenAny overload for 8 properties with a selector and distinct-until-changed flag.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies the string-based WhenAny overload for 8 properties with a selector.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    public async Task WhenAny_8Props_Sel_Str()
    {
        var vm = new WhenAnyArityTestViewModel();
        var list = new List<string>();
        _ = vm.WhenAny<WhenAnyArityTestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?>(
    ...
    /// <summary>Verifies the string-based WhenAny overload for 8 properties with a selector and distinct-until-changed flag.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies the WhenAnyValue overload for 8 properties with a selector.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies the WhenAnyValue overload for 8 properties with a selector and distinct-until-changed flag.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies the string-based WhenAnyValue overload for 8 properties with a selector.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    public async Task WhenAnyValue_8Props_Sel_Str()
    {
        var vm = new WhenAnyArityTestViewModel();
        var list = new List<string>();
        _ = vm.WhenAnyValue<WhenAnyArityTestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?>(
            nameof(WhenAnyArityTestViewModel.Property1),
            nameof(WhenAnyArityTestViewModel.Property2),
            nameof(WhenAnyArityTestViewModel.Property3),
            nameof(WhenAnyArityTestViewModel.Property4),
    ...
    /// <summary>Verifies the string-based WhenAnyValue overload for 8 properties with a selector and distinct-until-changed flag.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
