...
public partial class WhenAnyMixinTests
{
    ...
    public async Task WhenAny_9Props_Sel_Str()
    {
        var vm = new WhenAnyArityTestViewModel();
        var list = new List<string>();
        vm.WhenAny<WhenAnyArityTestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
    ...
    public async Task WhenAnyValue_9Props_Sel_Str()
    {
        var vm = new WhenAnyArityTestViewModel();
        var list = new List<string>();
        vm.WhenAnyValue<WhenAnyArityTestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
            nameof(WhenAnyArityTestViewModel.Property1),
            nameof(WhenAnyArityTestViewModel.Property2),
            nameof(WhenAnyArityTestViewModel.Property3),
            nameof(WhenAnyArityTestViewModel.Property4),
