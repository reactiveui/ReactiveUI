...
/// <content>Direct arity-8 <c>WhenAnyChangeSink</c> coverage.</content>
...
public partial class WhenAnySinkDirectTests
{
    ...
    [Test]
    public async Task ChangeSink8_Emits()
    {
        ...
        using var sub = new WhenAnyChangeSink<string, string, string, string, string, string, string, string, string>(
            s1,
            s2,
            s3,
            s4,
    ...
    /// <summary>Verifies the arity-8 change sink forwards a source error to the observer.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ChangeSink8_ForwardsError()
    {
        ...
        var rec = new Recorder<string>();
        new WhenAnyChangeSink<string, string, string, string, string, string, string, string, string>(
            e1,
            e2,
            e3,
            e4,
    ...
    /// <summary>Verifies the arity-8 change sink completes once every source completes.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ChangeSink8_Completes()
    {
    ...
    /// <summary>Verifies a throwing selector surfaces as an error from the arity-8 change sink.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    public async Task ChangeSink8_SelectorThrows()
    {
