...
/// <content>
/// Arity-10 WhenAnyObservable overload tests.
/// </content>
[SuppressMessage(
    "Major Code Smell",
...
{
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 10 observable properties.
    /// </summary>
    ...
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 10 observable properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
