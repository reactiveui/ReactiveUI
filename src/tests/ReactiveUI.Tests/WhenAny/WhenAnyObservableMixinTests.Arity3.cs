...
/// <content>
/// Arity-3 WhenAnyObservable overload tests.
/// </content>
public partial class WhenAnyObservableMixinTests
{
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 3 observable properties.
    /// </summary>
    ...
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 3 observable properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
