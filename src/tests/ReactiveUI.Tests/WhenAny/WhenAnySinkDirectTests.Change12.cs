...
{
    /// <summary>Verifies the arity-12 change sink emits when every source is ready and re-emits per later source update.</summary>
    ...
    /// <summary>Verifies the arity-12 change sink forwards a source error to the observer.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies the arity-12 change sink completes once every source completes.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies a throwing selector surfaces as an error from the arity-12 change sink.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
