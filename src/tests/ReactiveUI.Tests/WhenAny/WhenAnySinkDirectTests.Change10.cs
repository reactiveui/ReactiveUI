...
/// <content>Direct arity-10 <c>WhenAnyChangeSink</c> coverage.</content>
...
public partial class WhenAnySinkDirectTests
{
    ...
    public async Task ChangeSink10_ForwardsError()
    {
        ...
        var rec = new Recorder<string>();
        new WhenAnyChangeSink<string, string, string, string, string, string, string, string, string, string, string>(
            e1,
            e2,
            e3,
            e4,
