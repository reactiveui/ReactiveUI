...
/// <content>
/// Arity-12 WhenAnyObservable overload tests.
/// </content>
[SuppressMessage(
    "Major Code Smell",
...
{
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 12 observable properties.
    /// </summary>
    ...
    /// <summary>
    ///     Verifies the WhenAnyObservable overload for 12 observable properties with a selector.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
