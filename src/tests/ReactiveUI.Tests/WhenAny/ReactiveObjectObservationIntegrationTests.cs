...
/// <summary>Exercises generated Binding property observation with ReactiveUI view models.</summary>
public partial class ReactiveObjectObservationIntegrationTests
{
    ...
    public async Task AnyChangeInExpressionListTriggersUpdate()
    {
        ...
        _ = obj.WhenChanged(static x => x.Model.Model.Model.SomeOtherParam).Subscribe(_ => obsUpdated = true);
    ...
    public async Task NonNullableTypesTestShouldntNeedDecorators2()
    {
        ...
        _ = fixture.WhenAnyValue(
            ...
            x => x.AccountService.AccountUsers).Where(static tuple => tuple.Property1?.Count > 0 && tuple.Property2?.Count > 0).Select(static tuple =>
                {
                    var (_, users) = tuple;
    ...
    public async Task NullableTypesTestShouldntNeedDecorators2()
    {
        ...
        _ = fixture.WhenAnyValue(
            ...
            x => x.AccountService.AccountUsersNullable).Where(static tuple => tuple.Property1.Count > 0 && tuple.Property2?.Count > 0).Select(static tuple =>
                {
                    var (_, users) = tuple;
    ...
    public async Task ObjectShouldBeGarbageCollectedWhenPropertyValueChanges()
    {
        static (ObjChain1, WeakReference) GetWeakReference1()
        {
            ...
            _ = obj.WhenChanged(static x => x.Model.Model.Model.SomeOtherParam).Subscribe();
    ...
    public async Task WhenAnyShouldWorkEvenWithNormalProperties()
    {
        ...
        using (Assert.Multiple())
        {
            ...
            await Assert.That(output3[0]!.Expression).IsNull();
