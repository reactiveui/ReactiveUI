...
/// <content>Direct arity-10 <c>WhenAnyValueSink</c> coverage.</content>
...
public partial class WhenAnySinkDirectTests
{
    ...
    public async Task ValueSink10_ForwardsError()
    {
        ...
        var rec = new Recorder<string>();
        new WhenAnyValueSink<object?, string, string, string, string, string, string, string, string, string, string, string>(
            e1,
            e2,
            e3,
            e4,
