...
/// <c>LightChangeSet</c>, <c>DynamicDataInterop</c>, <see cref="ChangeSetMixin"/>, <see cref="CollectionChangedExtensions"/>,
...
public class ChangeSetsTests
{
    ...
    /// <summary>Verifies <see cref="ChangeSetMixin.CountChanged{T}(IObservable{IChangeSet{T}})"/> drops non-count change sets.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Verifies <see cref="ChangeSetMixin.HasCountChanged"/> reflects whether a DynamicData set alters the count.</summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    [Test]
    ...
    public async Task CollectionChanged_ValueEquality()
    {
        ...
        var c = new CollectionChanged(new object(), args);
