...
public class VariadicTemplatesTest
{
    ...
    public async Task WhenAnyValue_9Props_Sel_Str()
    {
        var vm = new TestViewModel();
        var list = new List<string>();
        vm.WhenAnyValue<TestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
                nameof(TestViewModel.Property1),
                nameof(TestViewModel.Property2),
                nameof(TestViewModel.Property3),
                nameof(TestViewModel.Property4),
    ...
    public async Task WhenAnyValue_10Props_Sel_Str()
    {
        var vm = new TestViewModel();
        var list = new List<string>();
        vm.WhenAnyValue<TestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
                nameof(TestViewModel.Property1),
                nameof(TestViewModel.Property2),
                nameof(TestViewModel.Property3),
                nameof(TestViewModel.Property4),
    ...
    public async Task WhenAnyValue_11Props_Sel_Str()
    {
        var vm = new TestViewModel();
        var list = new List<string>();
        vm.WhenAnyValue<TestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
                nameof(TestViewModel.Property1),
                nameof(TestViewModel.Property2),
                nameof(TestViewModel.Property3),
                nameof(TestViewModel.Property4),
    ...
    public async Task WhenAnyValue_12Props_Sel_Str()
    {
        var vm = new TestViewModel();
        var list = new List<string>();
        vm.WhenAnyValue<TestViewModel, string, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?, string?>(
                nameof(TestViewModel.Property1),
                nameof(TestViewModel.Property2),
                nameof(TestViewModel.Property3),
                nameof(TestViewModel.Property4),
    ...
    private class TestViewModel : ReactiveObject
    {
        ...
        public IObservable<string>? ObservableProperty1 { get => _observableProperty1; set => this.RaiseAndSetIfChanged(ref _observableProperty1, value); }

        public string? Property2 { get => _property2; set => this.RaiseAndSetIfChanged(ref _property2, value); }

        public IObservable<string>? ObservableProperty2 { get => _observableProperty2; set => this.RaiseAndSetIfChanged(ref _observableProperty2, value); }

        public string? Property3 { get => _property3; set => this.RaiseAndSetIfChanged(ref _property3, value); }

        public IObservable<string>? ObservableProperty3 { get => _observableProperty3; set => this.RaiseAndSetIfChanged(ref _observableProperty3, value); }

        public string? Property4 { get => _property4; set => this.RaiseAndSetIfChanged(ref _property4, value); }

        public IObservable<string>? ObservableProperty4 { get => _observableProperty4; set => this.RaiseAndSetIfChanged(ref _observableProperty4, value); }

        public string? Property5 { get => _property5; set => this.RaiseAndSetIfChanged(ref _property5, value); }

        public IObservable<string>? ObservableProperty5 { get => _observableProperty5; set => this.RaiseAndSetIfChanged(ref _observableProperty5, value); }

        public string? Property6 { get => _property6; set => this.RaiseAndSetIfChanged(ref _property6, value); }

        public IObservable<string>? ObservableProperty6 { get => _observableProperty6; set => this.RaiseAndSetIfChanged(ref _observableProperty6, value); }

        public string? Property7 { get => _property7; set => this.RaiseAndSetIfChanged(ref _property7, value); }

        public IObservable<string>? ObservableProperty7 { get => _observableProperty7; set => this.RaiseAndSetIfChanged(ref _observableProperty7, value); }

        public string? Property8 { get => _property8; set => this.RaiseAndSetIfChanged(ref _property8, value); }

        public IObservable<string>? ObservableProperty8 { get => _observableProperty8; set => this.RaiseAndSetIfChanged(ref _observableProperty8, value); }

        public string? Property9 { get => _property9; set => this.RaiseAndSetIfChanged(ref _property9, value); }

        public IObservable<string>? ObservableProperty9 { get => _observableProperty9; set => this.RaiseAndSetIfChanged(ref _observableProperty9, value); }

        public string? Property10 { get => _property10; set => this.RaiseAndSetIfChanged(ref _property10, value); }

        public IObservable<string>? ObservableProperty10 { get => _observableProperty10; set => this.RaiseAndSetIfChanged(ref _observableProperty10, value); }

        public string? Property11 { get => _property11; set => this.RaiseAndSetIfChanged(ref _property11, value); }

        public IObservable<string>? ObservableProperty11 { get => _observableProperty11; set => this.RaiseAndSetIfChanged(ref _observableProperty11, value); }

        public string? Property12 { get => _property12; set => this.RaiseAndSetIfChanged(ref _property12, value); }

        public IObservable<string>? ObservableProperty12 { get => _observableProperty12; set => this.RaiseAndSetIfChanged(ref _observableProperty12, value); }
    }
}
