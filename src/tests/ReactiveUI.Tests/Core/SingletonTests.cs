...
/// <summary>Tests for ReactiveUI singleton classes.</summary>
public class SingletonTests
{
    /// <summary>Tests SingletonDataErrorsChangedEventArgs.Value static property.</summary>
    ...
    /// <summary>Tests SingletonPropertyChangedEventArgs.ErrorMessage static property.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests SingletonPropertyChangedEventArgs.HasErrors static property.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>Tests SingletonPropertyChangedEventArgs.Value static property.</summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
