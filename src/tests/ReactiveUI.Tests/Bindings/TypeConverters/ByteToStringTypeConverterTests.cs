...
/// <summary>
/// Tests for converting bytes to strings.
/// </summary>
public class ByteToStringTypeConverterTests
{
    ...
    /// <summary>
    /// Verifies that a byte value converts to its string representation.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>
    /// Verifies that the maximum byte value converts successfully.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>
    /// Verifies that the minimum byte value converts successfully.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
