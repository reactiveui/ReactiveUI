...
public class LongToNullableLongTypeConverterTests
{
    ...
    /// <summary>Verifies that converting a long value always succeeds.</summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    public async Task TryConvert_AlwaysSucceeds()
    {
        ...
        await Assert.That(output).IsEqualTo((long?)Value);
    }

    /// <summary>Verifies the converter source type is <see cref="long"/>.</summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>Verifies the converter target type is nullable <see cref="long"/>.</summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    public async Task TryConvertTyped_WithValidValue_ReturnsTrueAndOutput()
    {
        ...
        await Assert.That(result).IsEqualTo((long?)Value);
    }
