...
/// <summary>Tests for converting nullable decimal to strings.</summary>
public class NullableDecimalToStringTypeConverterTests
{
    ...
    /// <summary>Verifies that converting a nullable decimal to a string succeeds.</summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    /// <summary>Verifies that converting zero succeeds.</summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
