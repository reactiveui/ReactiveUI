...
public class StringToShortTypeConverterTests
{
    ...
    /// <summary>
    /// Verifies that a valid string converts to a short.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
    ...
    {
        var converter = new StringToShortTypeConverter();
        const short ExpectedValue = 1000;
    ...
    /// <summary>
    /// Verifies the converter target type is <see cref="short"/>.
    /// </summary>
    /// <returns>A task representing the asynchronous test.</returns>
    [Test]
