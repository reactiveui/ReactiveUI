...
/// <summary>
/// Extension helpers for asserting on and transforming sequences in tests.
/// </summary>
public static class EnumerableTestMixin
{
    ...
    /// <param name="lhs">The expected sequence.</param>
    ...
    /// <summary>
    /// Filters out consecutive duplicate elements, yielding only values that differ from their predecessor.
    /// </summary>
    ...
    /// <summary>
    /// Iterates the source sequence, yielding only values that differ from their predecessor.
    /// </summary>
    /// <typeparam name="T">The type of the elements in the sequence.</typeparam>
    /// <param name="enumerable">The source sequence.</param>
    /// <returns>The sequence with consecutive duplicates removed.</returns>
