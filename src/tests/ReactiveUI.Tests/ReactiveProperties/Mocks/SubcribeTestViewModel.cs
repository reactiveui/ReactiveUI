...
/// <summary>
/// A view model used to measure subscription behaviour across many reactive property subscribers.
/// </summary>
public sealed class SubcribeTestViewModel : IDisposable
{
    /// <summary>
    /// Collects the values received by all subscribers.
    /// </summary>
    private static readonly List<int> _items = [];

    /// <summary>
    /// Holds the created subscribers so they can be disposed.
    /// </summary>
    ...
    /// <summary>
    /// Gets the reactive property that subscribers observe.
    /// </summary>
    public ReactiveProperty<int> Property { get; } = new(1, ImmediateScheduler.Instance, false, false);

    /// <summary>
    /// Gets the time, in milliseconds, taken to create all subscribers.
    /// </summary>
    public long StartupTime { get; }

    /// <summary>
    /// Gets the number of subscribers created.
    /// </summary>
    public int SubscriberCount { get; }

    /// <summary>
    /// Gets the number of subscription events received.
    /// </summary>
    ...
    /// <summary>
    /// A simple subscriber that records values from the supplied observable.
    /// </summary>
