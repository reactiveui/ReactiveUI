...
public class ChangeSetMixinTest
{
    ...
    /// <summary>
    ///     Tests that WhenCountChanged filters to only count changes.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    public async Task WhenCountChanged_FiltersToOnlyCountChanges()
    {
        var subject = new Subject<IReactiveChangeSet<int>>();
        var results = new List<IReactiveChangeSet<int>>();

        subject.WhenCountChanged().ObserveOn(ImmediateScheduler.Instance).Subscribe(results.Add);
    ...
    /// <summary>
    ///     Tests that CountHasChanged throws for null changeSet.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Tests that CountHasChanged returns true when adds are present.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Tests that CountHasChanged returns false when only updates are present.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
    ...
    /// <summary>
    ///     Tests that CountHasChanged returns true when removes are present.
    /// </summary>
    /// <returns>A <see cref="Task" /> representing the asynchronous operation.</returns>
    [Test]
