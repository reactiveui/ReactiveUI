...
/// <summary>Collection AutoPersist and ActOnEveryObject tests.</summary>
public partial class AutoPersistHelperTest
{
    ...
    public async Task AutoPersistCollection_NullCollection_ThrowsArgumentNullException()
    {
        ...
        {
            _ = collection!.AutoPersistCollection(static _ => ImmutableReturnRxVoidSignal.Instance);
    ...
    public async Task AutoPersistCollection_NullMetadata_ThrowsArgumentNullException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(async () =>
        {
            _ = collection.AutoPersistCollection(static _ => ImmutableReturnRxVoidSignal.Instance, (AutoPersistHelperMixins.AutoPersistMetadata)null!);
            await Task.CompletedTask;
        });
    }
    ...
    public async Task AutoPersistCollection_MetadataWithoutDataContract_ThrowsArgumentException()
    {
        ...
        {
            _ = collection.AutoPersistCollection(static _ => ImmutableReturnRxVoidSignal.Instance, new Signal<RxVoid>(), metadata, interval: null);
            await Task.CompletedTask;
        });
    }
