...
/// <summary>A platform-agnostic smoke test that keeps this WinUI test assembly non-empty on non-Windows targets.</summary>
/// <remarks>
/// The WinUI-specific tests only compile and run on the Windows TFMs (see the project's Windows <c>&lt;Choose&gt;</c>
