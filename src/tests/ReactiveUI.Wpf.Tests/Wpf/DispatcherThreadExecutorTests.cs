...
/// <summary>Tests for <see cref="DispatcherThreadExecutor"/>.</summary>
public sealed class DispatcherThreadExecutorTests
{
    ...
    /// </remarks>
    private sealed class RecordingExecutor : DispatcherThreadExecutor
    {
