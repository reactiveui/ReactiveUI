...
/// <summary>A fake xaml command binding view.</summary>
public class FakeXamlCommandBindingView : Control, IViewFor<CommandBindingViewModel>
{
    ...
    public static readonly DependencyProperty ViewModelProperty =
        DependencyProperty.Register(nameof(ViewModel), typeof(CommandBindingViewModel), typeof(FakeXamlCommandBindingView), new(null));

    /// <summary>The button declared in xaml property.</summary>
    public static readonly DependencyProperty ButtonDeclaredInXamlProperty =
        DependencyProperty.Register(nameof(ButtonDeclaredInXaml), typeof(Button), typeof(FakeXamlCommandBindingView), new(null));
    ...
    /// <summary>Gets the name of button declared in xaml.</summary>
