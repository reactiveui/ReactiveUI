...
/// <summary>Provides a test implementation of the <see cref="ILogManager"/> interface that always returns the same logger instance.</summary>
...
{
    /// <summary>Gets a logger instance associated with the specified type.</summary>
