...
/// <summary>A component with Enabled property and generic event for testing AOT-safe binding.</summary>
public class EnabledComponent : Component
{
    /// <summary>A custom event using generic EventHandler.</summary>
    ...
    /// <summary>Raises the custom event.</summary>
