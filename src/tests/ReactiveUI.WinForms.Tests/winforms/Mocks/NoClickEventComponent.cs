...
/// <summary>A component with no Click or MouseUp event for testing zero affinity.</summary>
public class NoClickEventComponent : Component
{
    /// <summary>An event that is not Click or MouseUp.</summary>
    public event EventHandler? SomeOtherEvent;

    /// <summary>Raises the other event.</summary>
