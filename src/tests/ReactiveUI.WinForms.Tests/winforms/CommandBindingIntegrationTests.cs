...
/// <summary>Exercises generated Binding command calls against ReactiveUI commands and WinForms controls.</summary>
[NotInParallel]
...
public class CommandBindingIntegrationTests
{
    ...
    public async Task CommandBindByNameWireup()
    {
        ...
        var disp = view.BindCommand(vm, static x => x.Command1, static x => x.Command1);
    ...
    public async Task CommandBindByNameWireupWithParameter()
    {
        ...
        var disp = view.BindCommand(vm, static x => x.Command3, static x => x.Command1, static x => x.Parameter);
    ...
    public async Task CommandBindToExplicitEventWireupWithParameter()
    {
        ...
        var disp = view.BindCommand(vm, static x => x.Command3, static x => x.Command2, static x => x.Parameter, "MouseUp");
