...
public static class WinFormsReactiveUIBuilderExtensions
{
    ...
    /// </value>
    public static IScheduler WinFormsMainThreadScheduler { get; } = new WaitForDispatcherScheduler(static () =>
        new SynchronizationContextScheduler(new WindowsFormsSynchronizationContext()));
