...
namespace ReactiveUI
{
    ...
    {
        /// <summary>
        /// Creates a derived comparer based on the given parent comparer. The returned comparer will
        /// sort elements using the parent comparer first. If the parent considers the values equal
        /// elements will be sorted in ascending order based on the values returned by the provided
        /// selector. The selector values will be compared using the default comparer for the return
        ...
        /// sort elements using the parent comparer first. If the parent considers the values equal
        /// elements will be sorted in ascending order based on the values returned by the provided
        /// selector. The selector values will be compared using the provided comparer or the default
        /// comparer for the return type of the selector if no comparer is specified.
        /// </summary>
        ...
        /// Creates a derived comparer based on the given parent comparer. The returned comparer will
        /// sort elements using the parent comparer first. If the parent considers the values equal
        /// elements will be sorted in descending order based on the values returned by the provided
        /// selector. The selector values will be compared using the default comparer for the return
        /// type of the selector.
        /// </summary>
        /// <typeparam name="TValue">The type of the value.</typeparam>
    ...
    /// </summary>
    /// <remarks>
    /// If the type you're creating a comparer for is known this class is nothing more than an alias
    /// for the generic OrderedComparer. This class can be used to create comparers for anonymous types
    /// </remarks>
    public static class OrderedComparer
    {
        /// <summary>
        /// Creates a type inferred comparer builder for the element type of the enumerable. Useful
        /// for creating comparers for anonymous types. Note that the builder is not a comparer in
        /// itself, you need to use the OrderBy or OrderByDescending methods on the builder to get an
        /// actual comparer.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <summary>
        /// Creates a comparer builder for the specified type. Note that the builder is not a
        /// comparer in itself, you need to use the OrderBy or OrderByDescending methods on the
        /// builder to get an actual comparer. If the type is known at compile time this method is
        /// nothing more than an alias for the generic OrdedComparer class.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
    ...
    {
        /// <summary>
        /// Creates a comparer that will sort elements in ascending order based on the values
        /// returned by the provided selector. The values will be compared using the default comparer
        /// for the return type of the selector.
        /// </summary>
        /// <typeparam name="TValue">The type of the value.</typeparam>
        /// <param name="selector">A function supplying the values for the comparator.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a comparer that will sort elements in ascending order based on the values
        /// returned by the provided selector. The selector values will be compared using the
        /// provided comparer or the default comparer for the return type of the selector if no
        /// comparer is specified.
        /// </summary>
        /// <typeparam name="TValue">The type of the value.</typeparam>
        /// <param name="selector">A function supplying the values for the comparator.</param>
        /// <param name="comparer">
        /// The comparer to use when comparing the values returned by the selector. The default
        /// comparer for that type will be used if this parameter is null.
        /// </param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a comparer that will sort elements in descending order based on the values
        /// returned by the provided selector. The values will be compared using the default comparer
        /// for the return type of the selector.
        /// </summary>
        /// <typeparam name="TValue">The type of the value.</typeparam>
    ...
    internal sealed class ChainedComparer<T> : IComparer<T>
    {
        ...
        {
            int parentResult = this.parent == null ? 0 : this.parent.Compare(x, y);

            return parentResult != 0 ? parentResult : this.inner(x, y);
        }
    }
}