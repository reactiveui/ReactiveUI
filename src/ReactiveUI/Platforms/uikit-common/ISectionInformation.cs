...
#endif
/// <summary>Interface used to extract a common API between <see cref="UIKit.UIView"/> and <see cref="UIKit.UITableViewCell"/>.</summary>
...
internal interface ISectionInformation<in TUIViewCell>
{
    ...
    /// <summary>Gets the cell key selector.</summary>
    Func<object?, NSString>? CellKeySelector { get; }

    /// <summary>Gets the initialize cell action.</summary>
