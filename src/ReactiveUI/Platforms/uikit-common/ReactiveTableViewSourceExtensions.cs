...
#endif
/// <summary>Extension methods for <see cref="ReactiveTableViewSource{TSource}"/>.</summary>
public static class ReactiveTableViewSourceExtensions
{
    /// <summary>Provides table-view binding extension members for an observable of a collection.</summary>
    ...
    extension(IObservable<INotifyCollectionChanged> sourceObservable)
    {
        ...
        public IDisposable BindTo<TSource, TCell>(
            ...
            where TCell : UITableViewCell =>
            new MapSignal<INotifyCollectionChanged, TableSectionInformation<TSource, TCell>[]>(
                    sourceObservable,
                    src =>
                    [
