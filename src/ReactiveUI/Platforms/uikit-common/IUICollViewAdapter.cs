...
internal interface IUICollViewAdapter<TUIView, TUIViewCell>
{
    ...
    /// <summary>Reloads the data.</summary>
    void ReloadData();

    /// <summary>Begins the updates.</summary>
    void BeginUpdates();

    /// <summary>Performs the updates.</summary>
    /// <param name="updates">The updates.</param>
    /// <param name="completion">The completion.</param>
    void PerformUpdates(Action updates, Action completion);

    /// <summary>Ends the updates.</summary>
    void EndUpdates();

    /// <summary>Inserts the sections.</summary>
    /// <param name="indexes">The indexes.</param>
    void InsertSections(NSIndexSet indexes);

    /// <summary>Deletes the sections.</summary>
    /// <param name="indexes">The indexes.</param>
    void DeleteSections(NSIndexSet indexes);

    /// <summary>Reloads the sections.</summary>
    /// <param name="indexes">The indexes.</param>
    void ReloadSections(NSIndexSet indexes);

    /// <summary>Moves the section.</summary>
    /// <param name="fromIndex">From index.</param>
    /// <param name="toIndex">To index.</param>
    void MoveSection(int fromIndex, int toIndex);

    /// <summary>Inserts the items.</summary>
    /// <param name="paths">The paths.</param>
    void InsertItems(NSIndexPath[] paths);

    /// <summary>Deletes the items.</summary>
    /// <param name="paths">The paths.</param>
    void DeleteItems(NSIndexPath[] paths);

    /// <summary>Reloads the items.</summary>
    /// <param name="paths">The paths.</param>
    ...
    /// <summary>Dequeues the reusable cell.</summary>
