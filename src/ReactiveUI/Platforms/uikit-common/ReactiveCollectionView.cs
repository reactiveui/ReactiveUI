...
[RequiresDynamicCode("ReactiveCollectionView inherits from ReactiveObject which uses extension methods that require dynamic code generation")]
[RequiresUnreferencedCode("ReactiveCollectionView inherits from ReactiveObject which uses extension methods that may require unreferenced code")]
#endif
...
#if NET6_0_OR_GREATER
[RequiresDynamicCode("ReactiveCollectionView<TViewModel> inherits from ReactiveObject which uses extension methods that require dynamic code generation")]
[RequiresUnreferencedCode("ReactiveCollectionView<TViewModel> inherits from ReactiveObject which uses extension methods that may require unreferenced code")]
#endif
