...
#endif
/// <summary>A header or footer of a table section.</summary>
[DebuggerDisplay("{Title}, {Height}")]
public class TableSectionHeader
{
    /// <summary>Initializes a new instance of the <see cref="TableSectionHeader"/> class.</summary>
    ...
    /// <summary>Gets the function that creates the <see cref="UIView"/> used as header for this section. Overrides Title.</summary>
    public Func<UIView>? View { get; protected set; }

    /// <summary>Gets the height of the header.</summary>
    public float Height { get; protected set; }

    /// <summary>Gets the title for the section header, only used if View is null.</summary>
