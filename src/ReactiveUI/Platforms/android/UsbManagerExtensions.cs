...
#endif
/// <summary>Extension methods for the usb manager.</summary>
public static class UsbManagerExtensions
{
    /// <summary>The intent action used when requesting USB permission.</summary>
    private const string ActionUsbPermission = "com.reactiveui.USB_PERMISSION";

    /// <summary>Extends a <see cref="UsbManager"/> with reactive USB permission requests.</summary>
    /// <param name="manager">The UsbManager system service used to request permissions.</param>
    extension(UsbManager manager)
    {
        /// <summary>
        ...
        : IObservable<bool>
    {
        ...
        /// <returns>A disposable that unregisters the broadcast receiver when disposed.</returns>
