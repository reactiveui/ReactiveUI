...
#endif
/// <summary>An update for the index normalizer.</summary>
[DebuggerDisplay("{Type}, {Index}, {IsDuplicate}")]
public sealed class Update
{
    ...
    /// <summary>Gets a value indicating whether this instance is duplicate.</summary>
    public bool IsDuplicate { get; }

    /// <summary>Creates an update for the added index.</summary>
    /// <param name="index">The index.</param>
    /// <returns>The updated add.</returns>
    public static Update CreateAdd(int index) => new(UpdateType.Add, index);

    /// <summary>Creates an update for the deleted index.</summary>
    /// <param name="index">The index.</param>
    /// <returns>The updated delete.</returns>
    public static Update CreateDelete(int index) => new(UpdateType.Delete, index);

    /// <summary>Creates an update of the specified type.</summary>
    ...
    /// <summary>Created a duplicate update.</summary>
