...
/// <summary>
/// Conversion and change-projection helpers used by the two-way binding pipeline.
/// </summary>
public partial class PropertyBinderImplementation
{
    /// <summary>
    /// Dispatches a single conversion attempt to a converter, choosing the typed or fallback conversion path.
    /// </summary>
    ...
    /// <summary>
    /// Converts a view model property value into the corresponding view property value.
    /// </summary>
    ...
    /// <summary>
    /// Converts a view property value back into the corresponding view model property value.
    /// </summary>
    /// <typeparam name="TViewModelPropertyType">The view model property type.</typeparam>
    /// <typeparam name="TViewPropertyType">The view property type.</typeparam>
    /// <param name="converter">The resolved converter, or <see langword="null"/> when no converter applies.</param>
    ...
    /// <summary>
    /// Projects a change signal into the resolved value to apply, in the correct direction.
    /// </summary>
    ...
    /// <summary>
    /// Builds the merged observable that signals when either the view model or the view side changed.
    /// </summary>
    ...
    private static MergeObservable<bool> BuildChangeSource<TViewModel, TView, TDontCare>(
        ...
        BroadcastSubject<bool> signalInitialUpdate)
        where TViewModel : class
        where TView : class, IViewFor
    {
        var initialUpdateSignal = new SelectObservable<bool, bool>(signalInitialUpdate, static _ => true);
        var viewModelSignal = new SelectObservable<object, bool>(
            ...
            default:
                {
                    var primary = signalViewUpdate is null
                        ...
                        : new MergeObservable<bool>(
                        [
                            new SelectObservable<TDontCare, bool>(signalViewUpdate, static _ => true),
    ...
    /// <summary>
    /// Bundles the inputs required to create a two-way binding so they can be threaded through the binding pipeline.
    /// </summary>
    /// <typeparam name="TViewModel">The type of the view model.</typeparam>
    /// <typeparam name="TView">The type of the view.</typeparam>
    /// <typeparam name="TViewModelPropertyType">The type of the view model property.</typeparam>
