...
public static class CommandBinder
{
    ...
    public static IReactiveBinding<TView, TProp> BindCommandNonGeneric<TView, TViewModel, TProp, TControl, TParam>(
        ...
        where TViewModel : class
        where TProp : ICommand =>
        _binderImplementation.BindCommandNonGeneric(viewModel, view, propertyName, controlName, withParameter, toEvent);
    ...
    public static IReactiveBinding<TView, TProp> BindCommandNonGeneric<TView, TViewModel, TProp, TControl>(
        ...
        where TViewModel : class
        where TProp : ICommand =>
        _binderImplementation.BindCommandNonGeneric(viewModel, view, propertyName, controlName, toEvent);
        ...
        where TProp : ICommand
    {
        ...
        return _binderImplementation.BindCommandNonGeneric(
                                                 viewModel,
                                                 view,
                                                 propertyName,
                                                 controlName,
