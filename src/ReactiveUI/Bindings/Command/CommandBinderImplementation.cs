...
public class CommandBinderImplementation : ICommandBinderImplementation
{
    ...
    private static CompositeDisposable BindCommandInternal<
        TView,
        TProp,
        TParam,
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicEvents |
    ...
    /// <summary>Projects each value of a source through a selector. Specialised command-binding projection.</summary>
