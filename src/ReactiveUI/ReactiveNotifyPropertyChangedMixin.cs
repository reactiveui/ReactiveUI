...
{
    /// <summary>
    /// Reactive Notify Property Changed Mixin
    /// </summary>
    public static class ReactiveNotifyPropertyChangedMixin
    {
        ...
        /// <summary>
        /// ObservableForProperty returns an Observable representing the property change
        /// notifications for a specific property on a ReactiveObject. This method (unlike other
        /// Observables that return
        /// IObservedChange) guarantees that the Value property of the IObservedChange is set.
        /// </summary>
        /// <typeparam name="TSender">The type of the sender.</typeparam>
        /// <typeparam name="TValue">The type of the value.</typeparam>
        /// <param name="This">The this.</param>
        /// <param name="property">An Expression representing the property (i.e. 'x =&gt; x.SomeProperty.SomeOtherProperty'</param>
        /// <param name="beforeChange">
        /// If True, the Observable will notify immediately before a property is going to change.
        /// </param>
        ...
        /// <summary>
        /// ObservableForProperty returns an Observable representing the property change
        /// notifications for a specific property on a ReactiveObject, running the IObservedChange
        /// through a Selector function.
        /// </summary>
        /// <typeparam name="TSender">The type of the sender.</typeparam>
        /// <typeparam name="TValue">The type of the value.</typeparam>
        ...
        /// <summary>
        /// Subscribes to expression chain.
        /// </summary>
        /// <typeparam name="TSender">The type of the sender.</typeparam>
        /// <typeparam name="TValue">The type of the value.</typeparam>
