...
namespace ReactiveUI
{
    ...
    public static class WhenAnyMixin
    {
                ...
                bool isDistinct = true)
        {
                    ...
                    .SubscribeToExpressionChain<TSender,object?>(sender, property1, false, false, isDistinct: isDistinct).Select(selector);
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property1, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property2, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property2, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property3, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property3, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property4, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property4, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property5, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property5, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property6, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property6, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property7, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property7, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property8, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property8, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property9, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property9, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property10, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property10, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property11, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
                ...
                bool isDistinct = true)
        {
                        ...
                        .SubscribeToExpressionChain<TSender,object?>(sender, property11, false, false, isDistinct: isDistinct),
                                    ReactiveNotifyPropertyChangedMixin
                        .SubscribeToExpressionChain<TSender,object?>(sender, property12, false, false, isDistinct: isDistinct),
                                selector
            );
                    }
        }
