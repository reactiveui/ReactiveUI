...
public sealed class ViewMappingBuilder
{
    ...
    /// <summary>
    /// Maps a view model type to a view type with a custom factory function using the default contract.
    /// </summary>
    /// <typeparam name="TViewModel">The view model type.</typeparam>
    /// <typeparam name="TView">The view type implementing IViewFor&lt;TViewModel&gt;.</typeparam>
    ...
    /// <summary>
    /// Maps a view model type to a view resolved from the service locator using the default contract.
    /// </summary>
    /// <typeparam name="TViewModel">The view model type.</typeparam>
    /// <typeparam name="TView">The view type implementing IViewFor&lt;TViewModel&gt;.</typeparam>
    /// <returns>The builder for chaining.</returns>
