...
public static class ObservableLoggingMixin
{
    ...
    /// <summary>
    /// Returns an observable sequence that logs each notification using the specified logger object and message.
    /// </summary>
    /// <typeparam name="T">The type of the elements in the source observable sequence.</typeparam>
    /// <typeparam name="TObj">The type of the logger object. Must implement IEnableLogger.</typeparam>
    /// <param name="this">The source observable sequence whose notifications will be logged.</param>
    ...
    /// <summary>
    /// Returns an observable sequence that logs any exception and continues with a default empty sequence.
    /// </summary>
    ...
    public static IObservable<T> LoggedCatch<T, TObj>(
        this IObservable<T> @this,
        TObj @class)
        where TObj : IEnableLogger =>
    ...
    /// <summary>
    /// Returns an observable sequence that logs any exception and continues with the provided fallback sequence.
    /// </summary>
    /// <typeparam name="T">The type of the elements in the observable sequence.</typeparam>
    /// <typeparam name="TObj">The type of the logger, which must implement IEnableLogger.</typeparam>
    /// <param name="this">The source observable sequence to monitor for exceptions.</param>
    ...
    public static IObservable<T> LoggedCatch<T, TObj, TException>(
        this IObservable<T> @this,
        TObj @class,
