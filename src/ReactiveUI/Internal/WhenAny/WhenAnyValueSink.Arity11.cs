...
/// <summary>
/// Combines 11 observed property values, emitting the selector result once every
...
internal sealed class WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
    ...
    Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> selector) : IObservable<TResult>
{
    /// <inheritdoc/>
    public IDisposable Subscribe(IObserver<TResult> observer)
    {
        ...
        sink.Run(source1, source2, source3, source4, source5, source6, source7, source8, source9, source10, source11);
        return sink;
    }
    ...
    private sealed class Sink(IObserver<TResult> downstream, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> selector) : IDisposable
    {
        ...
        public void On1(IObservedChange<TSender, T1> change)
        {
            lock (_gate)
            {
                ...
                _has1 = true;
                if (!(_has2 && _has3 && _has4 && _has5 && _has6 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On2(IObservedChange<TSender, T2> change)
        {
            lock (_gate)
            {
                ...
                _has2 = true;
                if (!(_has1 && _has3 && _has4 && _has5 && _has6 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On3(IObservedChange<TSender, T3> change)
        {
            lock (_gate)
            {
                ...
                _has3 = true;
                if (!(_has1 && _has2 && _has4 && _has5 && _has6 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On4(IObservedChange<TSender, T4> change)
        {
            lock (_gate)
            {
                ...
                _has4 = true;
                if (!(_has1 && _has2 && _has3 && _has5 && _has6 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On5(IObservedChange<TSender, T5> change)
        {
            lock (_gate)
            {
                ...
                _has5 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has6 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On6(IObservedChange<TSender, T6> change)
        {
            lock (_gate)
            {
                ...
                _has6 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has5 && _has7 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On7(IObservedChange<TSender, T7> change)
        {
            lock (_gate)
            {
                ...
                _has7 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has5 && _has6 && _has8 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On8(IObservedChange<TSender, T8> change)
        {
            lock (_gate)
            {
                ...
                _has8 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has5 && _has6 && _has7 && _has9 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On9(IObservedChange<TSender, T9> change)
        {
            lock (_gate)
            {
                ...
                _has9 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has5 && _has6 && _has7 && _has8 && _has10 && _has11))
                {
                    return;
                }
        ...
        public void On10(IObservedChange<TSender, T10> change)
        {
            lock (_gate)
            {
                ...
                _has10 = true;
                if (!(_has1 && _has2 && _has3 && _has4 && _has5 && _has6 && _has7 && _has8 && _has9 && _has11))
                {
                    return;
                }
        ...
        private void Emit()
        {
            ...
            try
            {
                result = selector(_value1, _value2, _value3, _value4, _value5, _value6, _value7, _value8, _value9, _value10, _value11);
            }
            catch (Exception ex)
            {
