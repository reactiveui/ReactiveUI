...
/// <summary>
/// Forwards only the values chosen by a chooser (the no-allocation fused replacement for Rx
/// <c>Where</c>+<c>Select</c>). Shared across the binding internals.
/// </summary>
...
internal sealed class ChooseObservable<TIn, TOut>(IObservable<TIn> source, Func<TIn, (bool HasValue, TOut Value)> chooser) : IObservable<TOut>
{
    /// <inheritdoc/>
