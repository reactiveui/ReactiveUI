...
{
    /// <summary>
    /// Observes a collection's <see cref="INotifyCollectionChanged.CollectionChanged"/> event as a stream of
    /// <see cref="CollectionChanged"/> notifications.
    /// </summary>
    /// <param name="source">The collection to observe.</param>
    /// <returns>A stream of collection-changed notifications.</returns>
    public static IObservable<CollectionChanged> ObserveCollectionChanges(this INotifyCollectionChanged source)
    {
    ...
    private sealed class CollectionChangedObservable(INotifyCollectionChanged source) : IObservable<CollectionChanged>
    {
        ...
        private sealed class Subscription : IDisposable
        {
            ...
            private void OnCollectionChanged(object? sender, NotifyCollectionChangedEventArgs e) =>
                _observer.OnNext(new CollectionChanged(sender, e));
        }
    }
}
