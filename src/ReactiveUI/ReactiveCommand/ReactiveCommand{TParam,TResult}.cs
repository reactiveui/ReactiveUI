...
public class ReactiveCommand<TParam, TResult> : ReactiveCommandBase<TParam, TResult>
{
    ...
    /// <summary>Observers of <see cref="CanExecute"/>; replays the current effective value on subscribe.</summary>
    private readonly IObservable<bool> _canExecute;

    /// <summary>Observers of <see cref="IsExecuting"/>; replays the current value on subscribe.</summary>
    private readonly IObservable<bool> _isExecuting;

    /// <summary>Observers of <see cref="ThrownExceptions"/>.</summary>
        ...
        IScheduler? outputScheduler)
    {
        ...
        _canExecute = new BoolStream(this, isExecuting: false);
        _isExecuting = new BoolStream(this, isExecuting: true);
        _thrownExceptions = new ExceptionStream(this);
