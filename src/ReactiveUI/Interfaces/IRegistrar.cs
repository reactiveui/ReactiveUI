...
public interface IRegistrar
{
    ...
    void RegisterConstant<TService>(Func<TService> factory)
    ...
    void RegisterConstant<TService>(Func<TService> factory, string? contract)
        where TService : class;
    ...
    /// <param name="factory">A factory function that creates the service instance.</param>
    /// <param name="contract">An optional contract name for multiple registrations of the same type.</param>
    void Register<TService>(Func<TService> factory, string? contract)
        where TService : class;
}
