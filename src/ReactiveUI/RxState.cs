...
{
    /// <summary>
    /// The configured exception handler, or null if not yet initialized.
    /// </summary>
    private static IObserver<Exception>? _defaultExceptionHandler;

    /// <summary>
    /// Tracks whether the exception handler has been initialized; 0 = uninitialized, 1 = initialized.
    /// </summary>
