...
/// <summary>A <see cref="RoutedViewHost"/> that also finds pages registered only with the service locator.</summary>
/// <remarks>
/// <para>
...
public class RoutedViewHostUnsafe : RoutedViewHost
{
    ...
    /// <exception cref="InvalidOperationException">No <see cref="IScreen"/> is registered with the service locator.</exception>
