...
/// <summary>This is a <see cref="TitleBar"/> that is also an <see cref="IViewFor{T}"/>.</summary>
...
TViewModel> : TitleBar, IViewFor<TViewModel>
    where TViewModel : class
{
    ...
    public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(
        nameof(ViewModel),
        typeof(TViewModel),
        typeof(ReactiveTitleBar<TViewModel>),
