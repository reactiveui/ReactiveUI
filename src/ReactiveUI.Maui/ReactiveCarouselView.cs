...
/// <summary>This is an <see cref="CarouselView"/> that is also an <see cref="IViewFor{T}"/>.</summary>
/// <typeparam name="TViewModel">The type of the view model.</typeparam>
/// <seealso cref="CarouselView" />
/// <seealso cref="IViewFor{TViewModel}" />
public class ReactiveCarouselView<
    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes
        .PublicParameterlessConstructor)]
TViewModel> : CarouselView, IViewFor<TViewModel>
