...
{
    /// <summary>Determines the affinity score for the specified view type based on whether it implements the ICanActivate interface.</summary>
    ...
    /// <summary>Returns an observable sequence that indicates the activation state of the specified view.</summary>
        ...
        : IObservable<bool>
    {
        ...
        /// <param name="downstream">The observer that receives the boolean activation-state notifications.</param>
        private sealed class Sink(IObserver<bool> downstream) : IDisposable
        {
            ...
            /// <param name="activated">Emits when the view is activated.</param>
            /// <param name="deactivated">Emits when the view is deactivated.</param>
            public void Run(IObservable<RxVoid> activated, IObservable<RxVoid> deactivated)
            {
            ...
            /// <param name="branchValue">The constant boolean value emitted for each tick of this branch's source.</param>
            private sealed class BranchObserver(Sink parent, bool branchValue) : IObserver<RxVoid>
            {
                /// <inheritdoc/>
                public void OnNext(RxVoid value) => parent.OnBranchNext(branchValue);
