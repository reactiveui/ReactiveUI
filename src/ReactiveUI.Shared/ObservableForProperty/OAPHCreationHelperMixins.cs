...
public static class OAPHCreationHelperMixins
{
    ...
    extension<TRet>(IObservable<TRet> target)
    {
        /// <summary>
            ...
            where TObj : class, IReactiveObject
        {
            ...
            ArgumentValidation.ThrowIfNullOrWhiteSpace(property);
    ...
    /// <summary>Provides ObservableToProperty extension members for reactive objects.</summary>
    /// <typeparam name="TObj">The type of the target object that implements IReactiveObject.</typeparam>
    /// <param name="target">The object whose property will be updated in response to the observable sequence.</param>
    extension<TObj>(TObj target)
        where TObj : class, IReactiveObject
    {
        /// <summary>
