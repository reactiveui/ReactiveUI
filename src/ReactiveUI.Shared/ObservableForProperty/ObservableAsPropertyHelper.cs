...
public sealed class ObservableAsPropertyHelper<T> : IHandleObservableErrors, IDisposable, IEnableLogger
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with no initial value, no deferred subscription, and no scheduler.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with a specified initial value.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with a specified initial value and scheduler.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="initialValue">The initial value of the property.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with a specified initial value and deferred subscription flag.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="initialValue">The initial value of the property.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with a specified initial value and changing callback.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="onChanging">The action called before the property value changes; may be null.</param>
    /// <param name="initialValue">The initial value of the property.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with changing callback, initial value, and deferred subscription flag.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="onChanging">The action called before the property value changes; may be null.</param>
    /// <param name="initialValue">The initial value of the property.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with no initial value factory, no deferred subscription, and no scheduler.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="onChanging">The action called before the property value changes; may be null.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="ObservableAsPropertyHelper{T}"/> class with an initial value factory and deferred subscription flag.</summary>
    /// <param name="observable">The observable to base the property on.</param>
    /// <param name="onChanged">The action called when the property value changes.</param>
    /// <param name="onChanging">The action called before the property value changes; may be null.</param>
    /// <param name="getInitialValue">Factory that returns the initial value; null defaults to returning default(T).</param>
    ...
    /// <summary>Gets the last provided value from the Observable.</summary>
    public T Value
    {
        get
        {
    ...
    /// <summary>Constructs a default ObservableAsPropertyHelper with no initial value and no scheduler.</summary>
    /// <returns>A default property helper.</returns>
    public static ObservableAsPropertyHelper<T> Default() => new(Signal.Silent<T>(), static _ => { }, default, false, null);

    /// <summary>Constructs a default ObservableAsPropertyHelper with the specified initial value and no scheduler.</summary>
    ...
    public static ObservableAsPropertyHelper<T> Default(T? initialValue) =>
        new(Signal.Silent<T>(), static _ => { }, initialValue!, false, null);

    /// <summary>Constructs a default ObservableAsPropertyHelper with the specified initial value and scheduler.</summary>
    /// <param name="initialValue">The initial (and only) value of the property.</param>
    /// <param name="scheduler">The scheduler on which change notifications are delivered.</param>
    /// <returns>A default property helper.</returns>
    public static ObservableAsPropertyHelper<T> Default(T? initialValue, ISequencer? scheduler) =>
        new(Signal.Silent<T>(), static _ => { }, initialValue!, false, scheduler);

    /// <summary>Disposes this ObservableAsPropertyHelper.</summary>
    public void Dispose()
    {
        lock (_gate)
        {
