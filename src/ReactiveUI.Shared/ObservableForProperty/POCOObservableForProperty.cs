...
#endif
/// <summary>Final fallback implementation for <c>WhenAny</c>-style observation when no observable mechanism is available.</summary>
/// <remarks>
/// <para>
...
public sealed class POCOObservableForProperty : ICreatesObservableForProperty
{
    ...
    /// <summary>Logs a POCO observation warning at most once per (runtime type, property name) pair.</summary>
    ...
    private sealed class SingleScheduledChange(
        ...
        ISequencer scheduler) : IObservable<IObservedChange<object, object?>>
    {
        /// <inheritdoc/>
