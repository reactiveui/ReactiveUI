...
public sealed class ReactiveUIBuilder : AppBuilder, IReactiveUIBuilder, IReactiveUIInstance
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ReactiveUIBuilder" /> class.</summary>
    ...
    /// <summary>Configures the main thread scheduler for ReactiveUI.</summary>
    ...
    /// <summary>Configures the task pool scheduler for ReactiveUI.</summary>
    ...
    /// <summary>Adds a custom ReactiveUI registration action.</summary>
    ...
    /// <summary>Registers the platform-specific ReactiveUI services.</summary>
    ...
    /// <summary>Registers the core ReactiveUI services in an AOT-compatible manner.</summary>
    /// <returns>The builder instance for chaining.</returns>
    ...
    /// <summary>Automatically registers all views that implement IViewFor from the specified assembly.</summary>
    ...
    {
        ArgumentExceptionHelper.ThrowIfNull(platformConfigurations);
    ...
    /// <summary>Configures a custom exception handler for unhandled errors in ReactiveUI observables.</summary>
    ...
    /// <summary>Configures the non-generic suspension host for application lifecycle management.</summary>
    /// <returns>The builder instance for chaining.</returns>
    ...
    /// <summary>Configures custom cache size limits for ReactiveUI's internal memoizing caches.</summary>
    ...
    private void ConfigureSchedulers() =>
        ...
        {
            if (MainThreadScheduler is not null && _setRxAppMainScheduler)
            {
                RxSchedulers.MainThreadScheduler = MainThreadScheduler;
            }

            if (TaskpoolScheduler is null || !_setRxAppTaskPoolScheduler)
            {
                return;
            }
