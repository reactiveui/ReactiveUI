...
public interface IReactiveUIBuilder : IAppBuilder
{
    ...
    /// <summary>Configures the suspension driver.</summary>
    ...
    /// <summary>Configures the view locator.</summary>
    ...
    /// <summary>Fors the custom platform.</summary>
    ...
    /// <summary>Fors the platforms.</summary>
    ...
    /// <summary>Registers the singleton view.</summary>
    ...
    /// <summary>Registers the view.</summary>
    /// <typeparam name="TView">The type of the view.</typeparam>
    /// <typeparam name="TViewModel">The type of the view model.</typeparam>
    /// <returns>The builder instance for chaining.</returns>
    [SuppressMessage(
    ...
    /// <summary>Withes the main thread scheduler.</summary>
    /// <param name="scheduler">The scheduler.</param>
    /// <returns>
    /// The builder instance for chaining.
    /// </returns>
    IReactiveUIBuilder WithMainThreadScheduler(ISequencer scheduler);
    ...
    /// The builder instance for chaining.
    /// </returns>
    IReactiveUIBuilder WithMainThreadScheduler(ISequencer scheduler, bool setRxApp);
    ...
    /// <summary>Withes the platform services.</summary>
    /// <returns>The builder instance for chaining.</returns>
    IReactiveUIBuilder WithPlatformServices();

    /// <summary>Withes the registration.</summary>
    /// <param name="configureAction">The configure action.</param>
    /// <returns>The builder instance for chaining.</returns>
    IReactiveUIBuilder WithRegistration(Action<IMutableDependencyResolver> configureAction);

    /// <summary>Withes the registration on build.</summary>
    /// <param name="configureAction">The configure action.</param>
    /// <returns>The builder instance for chaining.</returns>
    IReactiveUIBuilder WithRegistrationOnBuild(Action<IMutableDependencyResolver> configureAction);

    /// <summary>Withes the task pool scheduler.</summary>
    /// <param name="scheduler">The scheduler.</param>
    /// <returns>
    /// The builder instance for chaining.
    /// </returns>
    IReactiveUIBuilder WithTaskPoolScheduler(ISequencer scheduler);
    ...
    /// The builder instance for chaining.
    /// </returns>
    IReactiveUIBuilder WithTaskPoolScheduler(ISequencer scheduler, bool setRxApp);
    ...
    /// <summary>Withes the views from assembly.</summary>
