...
#endif
/// <summary>Provides static methods for configuring and initializing ReactiveUI using the builder pattern.</summary>
...
public static class RxAppBuilder
{
    ...
    /// <summary>Creates a ReactiveUI builder with the Splat Locator instance.</summary>
    ...
    /// <summary>Ensures ReactiveUI has been initialized via the builder pattern. Throws an exception if BuildApp() has not been called.</summary>
    ...
    /// <summary>Resets the initialization state of ReactiveUI. This method is intended for testing purposes only.</summary>
    /// <remarks>
    ...
    /// <summary>Marks ReactiveUI as initialized. Called by ReactiveUIBuilder.BuildApp().</summary>
