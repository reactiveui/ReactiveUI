...
public static partial class WhenAnyMixins
{
    ...
    extension<TSender>(TSender? sender)
    {
        ...
        public IObservable<TRet> WhenAnyValue<TRet, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
            ...
            sender!.WhenAny(
                ...
                property9,
                property10,
                (c1, c2, c3, c4, c5, c6, c7, c8, c9, c10) => selector(c1.Value, c2.Value, c3.Value, c4.Value, c5.Value, c6.Value, c7.Value, c8.Value, c9.Value, c10.Value));
            ...
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TRet> selector)
        {
            ...
            return new WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TRet>(
                o1,
                o2,
                o3,
                o4,
        ...
        /// <returns>An observable that emits the projected result on each change.</returns>
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAny<TRet, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            Expression<Func<TSender, T4>> property4,
