...
#endif
/// <summary>Provides the arity-5 WhenAny / WhenAnyValue / WhenAnyDynamic extension overloads.</summary>
[SuppressMessage(
    "Design",
...
{
    /// <summary>Provides arity-5 WhenAny extension members for <typeparamref name="TSender"/>.</summary>
    ...
    extension<TSender>(TSender? sender)
    {
        ...
        public IObservable<(T1 Value1, T2 Value2, T3 Value3, T4 Value4, T5 Value5)> WhenAnyValue<T1, T2, T3, T4, T5>(
            ...
            sender!.WhenAny(
                ...
                property4,
                property5,
                static (c1, c2, c3, c4, c5) => (c1.Value, c2.Value, c3.Value, c4.Value, c5.Value));
            ...
            string property5Name)
        {
            ...
            return new WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, (T1 Value1, T2 Value2, T3 Value3, T4 Value4, T5 Value5)>(
                o1,
                o2,
                o3,
                o4,
        ...
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAnyValue<TRet, T1, T2, T3, T4, T5>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            Expression<Func<TSender, T4>> property4,
            ...
            sender!.WhenAny(
                ...
                property4,
                property5,
                (c1, c2, c3, c4, c5) => selector(c1.Value, c2.Value, c3.Value, c4.Value, c5.Value));
            ...
            Func<T1, T2, T3, T4, T5, TRet> selector)
        {
            ...
            var o4 = sender!.ObservableForProperty<TSender, T4>(property4Name, beforeChange: false, skipInitial: false, isDistinct: true);
            var o5 = sender!.ObservableForProperty<TSender, T5>(property5Name, beforeChange: false, skipInitial: false, isDistinct: true);
            return new WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, TRet>(
                o1,
                o2,
                o3,
                o4,
        ...
        /// <returns>An observable that emits the projected result on each change.</returns>
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAny<TRet, T1, T2, T3, T4, T5>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            Expression<Func<TSender, T4>> property4,
