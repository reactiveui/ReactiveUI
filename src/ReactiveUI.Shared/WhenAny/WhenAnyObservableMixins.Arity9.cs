...
#endif
/// <summary>Provides the arity-9 WhenAnyObservable extension overloads.</summary>
[SuppressMessage(
    "Design",
...
{
    /// <summary>Provides arity-9 WhenAnyObservable extension members for a source object.</summary>
        ...
        public IObservable<TRet> WhenAnyObservable<TRet>(
            ...
            new WhenAnyObservableMergeSink<TRet>(
                sender.WhenAny(
                    ...
                    obs8,
                    obs9,
                    static (o1, o2, o3, o4, o5, o6, o7, o8, o9) => new[]
                    {
        ...
        public IObservable<TRet> WhenAnyObservable<TRet, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
            ...
            new WhenAnyObservableSwitchSink<TRet>(
                sender.WhenAny(
                    ...
                    obs8,
                    obs9,
                    (o1, o2, o3, o4, o5, o6, o7, o8, o9) => (IObservable<TRet>)new WhenAnyChangeSink<T1, T2, T3, T4, T5, T6, T7, T8, T9, TRet>(
                        o1.Value!.EmptyIfNull(),
                        o2.Value!.EmptyIfNull(),
                        o3.Value!.EmptyIfNull(),
                        o4.Value!.EmptyIfNull(),
