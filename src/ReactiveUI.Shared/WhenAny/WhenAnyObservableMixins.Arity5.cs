...
#endif
/// <summary>Provides the arity-5 WhenAnyObservable extension overloads.</summary>
public static partial class WhenAnyObservableMixins
{
    /// <summary>Provides arity-5 WhenAnyObservable extension members for a source object.</summary>
        ...
        where TSender : class
    {
        ...
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAnyObservable<TRet, T1, T2, T3, T4, T5>(
            ...
            new WhenAnyObservableSwitchSink<TRet>(
                sender.WhenAny(
                    ...
                    obs4,
                    obs5,
                    (o1, o2, o3, o4, o5) => (IObservable<TRet>)new WhenAnyChangeSink<T1, T2, T3, T4, T5, TRet>(
                        o1.Value!.EmptyIfNull(),
                        o2.Value!.EmptyIfNull(),
                        o3.Value!.EmptyIfNull(),
                        o4.Value!.EmptyIfNull(),
