...
#endif
/// <summary>Provides the arity-8 WhenAny / WhenAnyValue / WhenAnyDynamic extension overloads.</summary>
[SuppressMessage(
    "Design",
...
{
    /// <summary>Provides arity-8 WhenAny extension members for <typeparamref name="TSender"/>.</summary>
    ...
    extension<TSender>(TSender? sender)
    {
        ...
        public IObservable<TRet> WhenAnyValue<TRet, T1, T2, T3, T4, T5, T6, T7, T8>(
            ...
            Func<T1, T2, T3, T4, T5, T6, T7, T8, TRet> selector)
        {
            ...
            return new WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, T6, T7, T8, TRet>(
                o1,
                o2,
                o3,
                o4,
        ...
        /// <returns>An observable that emits the projected result on each change.</returns>
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAny<TRet, T1, T2, T3, T4, T5, T6, T7, T8>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            Expression<Func<TSender, T4>> property4,
