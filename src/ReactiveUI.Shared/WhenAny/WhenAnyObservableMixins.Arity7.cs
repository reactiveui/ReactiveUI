...
public static partial class WhenAnyObservableMixins
{
        ...
        where TSender : class
    {
        ...
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAnyObservable<TRet, T1, T2, T3, T4, T5, T6, T7>(
            ...
            new WhenAnyObservableSwitchSink<TRet>(
                sender.WhenAny(
                    ...
                    obs6,
                    obs7,
                    (o1, o2, o3, o4, o5, o6, o7) => (IObservable<TRet>)new WhenAnyChangeSink<T1, T2, T3, T4, T5, T6, T7, TRet>(
                        o1.Value!.EmptyIfNull(),
                        o2.Value!.EmptyIfNull(),
                        o3.Value!.EmptyIfNull(),
                        o4.Value!.EmptyIfNull(),
