...
#endif
/// <summary>Provides the arity-3 WhenAny / WhenAnyValue / WhenAnyDynamic extension overloads.</summary>
[SuppressMessage(
    "Design",
...
{
    /// <summary>Provides arity-3 WhenAny extension members for the source object.</summary>
    ...
    extension<TSender>(TSender? sender)
    {
        ...
        public IObservable<(T1 Value1, T2 Value2, T3 Value3)> WhenAnyValue<T1, T2, T3>(
            ...
            sender!.WhenAny(
                ...
                property2,
                property3,
                static (c1, c2, c3) => (c1.Value, c2.Value, c3.Value));
            ...
            string property3Name)
        {
            ...
            return new WhenAnyValueSink<TSender, T1, T2, T3, (T1 Value1, T2 Value2, T3 Value3)>(
                o1,
                o2,
                o3,
        ...
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAnyValue<TRet, T1, T2, T3>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            ...
            sender!.WhenAny(
                ...
                property2,
                property3,
                (c1, c2, c3) => selector(c1.Value, c2.Value, c3.Value));
            ...
            Func<T1, T2, T3, TRet> selector)
        {
            ...
            var o2 = sender!.ObservableForProperty<TSender, T2>(property2Name, beforeChange: false, skipInitial: false, isDistinct: true);
            var o3 = sender!.ObservableForProperty<TSender, T3>(property3Name, beforeChange: false, skipInitial: false, isDistinct: true);
            return new WhenAnyValueSink<TSender, T1, T2, T3, TRet>(
                o1,
                o2,
                o3,
                selector);
        ...
        /// <returns>An observable that emits the projected result on each change.</returns>
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
        public IObservable<TRet> WhenAny<TRet, T1, T2, T3>(
            Expression<Func<TSender, T1>> property1,
            Expression<Func<TSender, T2>> property2,
            Expression<Func<TSender, T3>> property3,
            Func<IObservedChange<TSender, T1>, IObservedChange<TSender, T2>, IObservedChange<TSender, T3>, TRet> selector) =>
            new WhenAnyChangeSink<IObservedChange<TSender, T1>, IObservedChange<TSender, T2>, IObservedChange<TSender, T3>, TRet>(
        ...
        public IObservable<TRet> WhenAnyDynamic<TRet>(
            ...
            new WhenAnyChangeSink<IObservedChange<TSender, object?>, IObservedChange<TSender, object?>, IObservedChange<TSender, object?>, TRet>(
