...
public abstract class ReactiveCommandBase<TParam, TResult> : IReactiveCommand<TParam, TResult>, ICommand
{
    ...
    /// <summary>Tracks the most recent CanExecute value for ICommand compatibility.</summary>
    ...
    /// <summary>Will trigger a event when the CanExecute condition has changed.</summary>
