...
#endif
/// <summary>Encapsulates a user action behind a reactive interface.</summary>
/// <remarks>
/// <para>
...
{
    /// <summary>Creates a parameterless reactive command with synchronous execution logic.</summary>
    ...
    /// <summary>Creates a parameterless <see cref="ReactiveCommand{TParam, TResult}" /> with synchronous execution logic.</summary>
    /// <param name="execute">The action to execute whenever the command is executed.</param>
    /// <param name="canExecute">An optional observable that dictates the availability of the command for execution.</param>
    /// <param name="outputScheduler">An optional scheduler that is used to surface events. Defaults to <c>RxSchedulers.MainThreadScheduler</c>.</param>
    /// <returns>
    ...
    /// <summary>Creates a parameterless reactive command with asynchronous background execution logic.</summary>
    /// <param name="execute">The action to execute whenever the command is executed.</param>
    /// <returns>The ReactiveCommand instance.</returns>
    /// <exception cref="ArgumentNullException">execute.</exception>
    ...
    /// <summary>Creates a combined reactive command that composes all the provided child commands.</summary>
    /// <typeparam name="TParam">The type of the parameter passed through to command execution.</typeparam>
    ...
    /// <summary>Creates a parameterless reactive command with asynchronous observable execution logic.</summary>
    /// <typeparam name="TResult">The type of the command's result.</typeparam>
    ...
    /// <summary>Creates a parameterless reactive command with asynchronous task-based execution logic returning TResult.</summary>
    /// <typeparam name="TResult">The type of the command's result.</typeparam>
        ...
        ISequencer? outputScheduler)
    {
        ...
        return CreateFromObservableCancellable<RxVoid, TResult>(
        ...
        ISequencer? outputScheduler)
    {
        ...
        return CreateFromObservableCancellable<RxVoid, RxVoid>(
            () => ObservableMixins.FromAsyncWithAllNotifications(execute),
            canExecute,
            outputScheduler);
    }
