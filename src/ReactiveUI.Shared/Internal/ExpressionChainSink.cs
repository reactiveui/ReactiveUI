    ...
    : IObservable<IObservedChange<TSender, TValue>>
{
    ...
    private sealed class Sink : IDisposable
    {
        ...
        /// <summary>Coerces the raw observed value into <typeparamref name="TValue"/>, forwarding a cast error if it is neither <see langword="null"/> nor assignable.</summary>
