...
#endif
/// <summary>
/// Combines 8 observed property values, emitting the selector result once every
...
internal sealed class WhenAnyValueSink<TSender, T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
