...
/// <see cref="ReplaySignal{T}"/> instances exposed here and view models subscribe through <see cref="ISuspensionHost"/>.
/// </para>
/// <para>
...
/// object is intentionally thread-safe via <see cref="ReplaySignal{T}"/> so events raised prior to subscription are
...
internal class SuspensionHost : ReactiveObject, ISuspensionHost, IDisposable
{
    ...
    /// <summary>Gets or sets a observable which notifies when the application is resuming.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets a observable which notifies when the application is un-pausing.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets a observable which notifies when the application should persist its state.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets a observable which notifies when a application is launching new.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets a observable which notifies when the application state should be invalidated.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets a Func which will generate a fresh application state.</summary>
    /// <remarks>
    ...
    /// <summary>Gets or sets the application state that will be used when suspending and resuming the class.</summary>
    /// <remarks>
