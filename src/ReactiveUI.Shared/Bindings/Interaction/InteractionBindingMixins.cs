...
{
    /// <summary>The binder implementation that handles interaction registrations.</summary>
    private static readonly InteractionBinderImplementation _binderImplementation = new();

    /// <summary>Provides interaction binding extension members for views.</summary>
