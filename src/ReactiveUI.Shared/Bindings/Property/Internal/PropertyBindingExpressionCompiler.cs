...
#endif
/// <summary>Default implementation of <see cref="IPropertyBindingExpressionCompiler"/> that compiles and analyzes property binding expressions.</summary>
/// <remarks>
...
internal class PropertyBindingExpressionCompiler : IPropertyBindingExpressionCompiler
{
    ...
    /// <summary>Creates the default value instance for <paramref name="type"/> used by the "replay on host changes" logic.</summary>
    ...
    /// <summary>Mutable per-subscription state for a chained set-observable.</summary>
        ...
        object target) : IObservable<(bool ShouldEmit, TValue Value)>
    {
        ...
        /// <summary>Determines whether the current value of the bound member on <paramref name="host"/> equals its type default.</summary>
        ...
        /// <summary>Applies <paramref name="value"/> to <paramref name="host"/> and emits the effective value when it changed.</summary>
        /// <param name="context">The binding context.</param>
        ...
        /// <summary>Handles a change of the binding host, replaying the last observed value when appropriate.</summary>
        /// <param name="context">The binding context.</param>
        /// <param name="state">The mutable subscription state.</param>
        /// <param name="observer">The observer to emit to.</param>
        ...
        /// <summary>Handles a new observed source value, resolving the current host and applying the value to it.</summary>
        /// <param name="context">The binding context.</param>
        /// <param name="state">The mutable subscription state.</param>
        ...
        /// <summary>Resolves the current host object for the binding by evaluating the host expression chain.</summary>
        /// <param name="target">The root binding target.</param>
    ...
    /// <summary>Immutable dependencies shared across a single chained set-observable subscription.</summary>
