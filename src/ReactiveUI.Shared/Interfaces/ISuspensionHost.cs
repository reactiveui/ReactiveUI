...
public interface ISuspensionHost : IReactiveObject
{
    ...
    /// </summary>
    IObservable<RxVoid> IsLaunchingNew { get; set; }
    ...
    /// </summary>
    IObservable<RxVoid> IsResuming { get; set; }
    ...
    /// </summary>
    IObservable<RxVoid> IsUnpausing { get; set; }
    ...
    /// </summary>
    IObservable<RxVoid> ShouldInvalidateState { get; set; }
