...
#if REACTIVE_SHIM
namespace ReactiveUI.Reactive.Interfaces;
#else
namespace ReactiveUI.Interfaces;
#endif
/// <summary>Represents a standardized version of host operating system lifecycle signals with a strongly-typed application state.</summary>
