    ...
    where TSender : IReactiveObject
{
    ...
    private readonly Lazy<ISignal<Exception>> _thrownExceptions = new(static () =>
        new ScheduledSubject<Exception>(Sequencer.Immediate, RxState.DefaultExceptionHandler));
    ...
    private readonly Lazy<DelayableNotificationSignal<IReactivePropertyChangedEventArgs<TSender>>> _changing;

    /// <summary>Lazily initialized delayable sink for property changed notifications (also the Changed observable).</summary>
    private readonly Lazy<DelayableNotificationSignal<IReactivePropertyChangedEventArgs<TSender>>> _changed;

    /// <summary>Lazily initialized delayable sink that raises PropertyChanging events.</summary>
    private readonly Lazy<DelayableNotificationSignal<ReactivePropertyChangingEventArgs<TSender>>> _propertyChanging;

    /// <summary>Lazily initialized delayable sink that raises PropertyChanged events.</summary>
    private readonly Lazy<DelayableNotificationSignal<ReactivePropertyChangedEventArgs<TSender>>> _propertyChanged;
    ...
    /// <summary>Initializes a new instance of the <see cref="ExtensionState{TSender}"/> class.</summary>
    ...
    /// <summary>Gets an observable sequence that signals before a property value changes on the object.</summary>
    ...
    /// <summary>Gets an observable sequence that signals when a property value on the object has changed.</summary>
    ...
    /// <summary>Gets an observable sequence of exceptions that have been thrown by the component.</summary>
    ...
    /// <summary>Subscribes to property changing events for the current instance.</summary>
    ...
    /// <summary>Subscribes to property changed events for the current instance.</summary>
    ...
    private static void FlushIfCreated<T>(Lazy<DelayableNotificationSignal<T>> sink)
    {
