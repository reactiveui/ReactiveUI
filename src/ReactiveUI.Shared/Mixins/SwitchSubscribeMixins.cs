...
/// </para>
/// </remarks>
public static class SwitchSubscribeMixins
{
    /// <summary>Provides SwitchSubscribe extension members for <see cref="IObservable{T}"/> streams that emit inner observables.</summary>
    ...
    extension<T>(IObservable<IObservable<T>?> source)
    {
        ...
        /// </code>
        /// </example>
        public IDisposable SwitchSubscribe(Action<T> onNext)
        {
        ...
        public IDisposable SwitchSubscribe(
            Action<T> onNext,
    ...
    /// <summary>Provides SwitchSubscribe and SwitchSelect extension members for <see cref="IObservable{T}"/> streams of <see cref="IReactiveCommand{TParam, TResult}"/> instances.</summary>
    ...
    extension<TParam, TResult>(IObservable<IReactiveCommand<TParam, TResult>?> source)
    {
        /// <summary>
        ...
        /// </code>
        /// </example>
        public IDisposable SwitchSubscribe(Action<TResult> onNext)
        {
            ArgumentExceptionHelper.ThrowIfNull(source);
            ArgumentExceptionHelper.ThrowIfNull(onNext);
        ...
        /// </code>
        /// </example>
        public IDisposable SwitchSubscribe<TValue>(
        ...
        /// </code>
        /// </example>
        public IObservable<TValue> SwitchSelect<TValue>(
            Func<IReactiveCommand<TParam, TResult>, IObservable<TValue>> selector)
        {
            ArgumentExceptionHelper.ThrowIfNull(source);
            ArgumentExceptionHelper.ThrowIfNull(selector);
    ...
    /// <summary>Provides SwitchSubscribe and SwitchSelect extension members for <see cref="IObservable{T}"/> streams of projectable inner observables.</summary>
    ...
    extension<TSource>(IObservable<TSource?> source)
    {
        ...
        /// </code>
        /// </example>
        public IDisposable SwitchSubscribe<TResult>(
        ...
        /// </code>
        /// </example>
        public IObservable<TResult> SwitchSelect<TResult>(
            Func<TSource, IObservable<TResult>> selector)
        {
            ArgumentExceptionHelper.ThrowIfNull(source);
            ArgumentExceptionHelper.ThrowIfNull(selector);
        ...
        Func<TSource, IObservable<TResult>> selector) : IObservable<TResult>
    {
            ...
            : IObserver<TSource?>, IDisposable
        {
            ...
            /// <param name="parent">The owning sink to forward notifications to.</param>
            /// <param name="id">The generation id of this inner subscription, used to ignore stale notifications.</param>
