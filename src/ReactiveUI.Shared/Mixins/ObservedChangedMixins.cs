...
{
    /// <summary>Initializes static members of the <see cref="ObservedChangedMixins"/> class.</summary>
    static ObservedChangedMixins() => RxAppBuilder.EnsureInitialized();

    /// <summary>Provides value-projection extension members for <see cref="IObservable{T}"/> streams of <see cref="IObservedChange{TSender, TValue}"/>.</summary>
    ...
    /// <summary>Provides value-access extension members for <see cref="IObservedChange{TSender, TValue}"/>.</summary>
    ...
    /// <param name="item">The observed change instance.</param>
    extension<TSender, TValue>(IObservedChange<TSender, TValue> item)
    {
        /// <summary>Retrieves the name of the property associated with the observed change.</summary>
        ...
        /// <summary>Gets the current value from the observed change, or the default value for the type if the value cannot be retrieved.</summary>
    ...
    /// <summary>A fused sink that projects each observed change to its current value via <see cref="GetValue{TSender, TValue}"/>.</summary>
        ...
        : IObservable<TValue>
    {
        ...
        /// <param name="downstream">The observer that receives the projected values.</param>
        [RequiresUnreferencedCode("Evaluates expression-based member chains via reflection; members may be trimmed.")]
