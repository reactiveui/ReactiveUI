...
namespace ReactiveUI.Android
{
    ...
    /// </summary>
    public class ReactiveSherlockActivity<TViewModel> : ReactiveSherlockActivity, IViewFor<TViewModel>, ICanActivate
        where TViewModel : class, IReactiveNotifyPropertyChanged
    {
        protected ReactiveSherlockActivity() { }
    ...
    /// (i.e. you can call RaiseAndSetIfChanged)
    /// </summary>
    public class ReactiveSherlockActivity : SherlockActivity, IReactiveNotifyPropertyChanged, IHandleObservableErrors
    {
        protected ReactiveSherlockActivity()
        {
