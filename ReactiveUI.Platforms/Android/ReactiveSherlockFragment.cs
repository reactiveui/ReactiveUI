...
namespace ReactiveUI.Android
{
    ...
    /// <summary>
    /// This is a SherlockFragment that is both an SherlockFragment and has ReactiveObject powers 
    /// (i.e. you can call RaiseAndSetIfChanged)
    /// </summary>
    public class ReactiveSherlockFragment<TViewModel> : ReactiveSherlockFragment, IViewFor<TViewModel>, ICanActivate
        where TViewModel : class, IReactiveNotifyPropertyChanged
    {
        protected ReactiveSherlockFragment() { }
    ...
    /// (i.e. you can call RaiseAndSetIfChanged)
    /// </summary>
    public class ReactiveSherlockFragment : SherlockFragment, IReactiveNotifyPropertyChanged, IHandleObservableErrors
    {
        protected ReactiveSherlockFragment() 
        {
            setupRxObj();
