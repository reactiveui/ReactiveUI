...
{
    /// <summary>
    /// This is an SherlockFragmentActivity that is both an SherlockFragmentActivity and has ReactiveObject powers 
    /// (i.e. you can call RaiseAndSetIfChanged)
    /// </summary>
    public class ReactiveSherlockFragmentActivity<TViewModel> : ReactiveSherlockFragmentActivity, IViewFor<TViewModel>, ICanActivate
        where TViewModel : class, IReactiveNotifyPropertyChanged
    {
        protected ReactiveSherlockFragmentActivity() { }
    ...
    /// (i.e. you can call RaiseAndSetIfChanged)
    /// </summary>
    public class ReactiveSherlockFragmentActivity : SherlockFragmentActivity, IReactiveNotifyPropertyChanged, IHandleObservableErrors
    {
        protected ReactiveSherlockFragmentActivity()
        {
