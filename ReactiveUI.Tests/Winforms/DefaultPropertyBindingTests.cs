namespace ReactiveUI.Tests.Winforms
{
    ...
    public class DefaultPropertyBindingTests
    {
         ...
         public void CanAutoBindViewModelToWinformView()
         {
             ...
             view.SomeDouble.Text = (2347746.44d).ToString();
             Assert.Equal(vm.SomeDouble.ToString(), view.SomeDouble.Text);
    ...
    public class FakeWinformViewModel : ReactiveObject
    {
        ...
        public int SomeInteger
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref this.someInteger, value);
            }
        }
        ...
        public string SomeText
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref this.someText, value);
            }
        }
        ...
        public double SomeDouble
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref this.someDouble, value);
            }
        }
        ...
        public string Property1
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref _property1, value);
            }
        }
        ...
        public string Property2
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref _property2, value);
            }
        }
        ...
        public string Property3
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref _property3, value);
            }
        }
        ...
        public string Property4
        {
            ...
            set
            {
                this.RaiseAndSetIfChanged(ref _property4, value);
            }
        }
        ...
        public bool BooleanProperty
        {
            get
            {
                return _someBooleanProperty;
            }
            set
            {
                this.RaiseAndSetIfChanged(ref _someBooleanProperty, value);
            }
        }
    }
    ...
    public class FakeWinformsView : Control, IViewFor<FakeWinformViewModel>
    {
        object IViewFor.ViewModel
        {
            ...
            set
            {
                ViewModel = (FakeWinformViewModel)value;
            }
        }
